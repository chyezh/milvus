...
// AssignmentState represents the state of WAL assignment process.
type AssignmentState int32

const (
	AssignmentState_ASSIGNMENT_STATE_UNKNOWN            AssignmentState = 0
	AssignmentState_ASSIGNMENT_STATE_FENCING            AssignmentState = 1 // Fencing old WAL Owner
	AssignmentState_ASSIGNMENT_STATE_PERSIST_RECOVERING AssignmentState = 2 // Loading metadata from Catalog
	AssignmentState_ASSIGNMENT_STATE_STREAM_RECOVERING  AssignmentState = 3 // Replaying messages from WAL stream
)

// Enum value maps for AssignmentState.
var (
	AssignmentState_name = map[int32]string{
		0: "ASSIGNMENT_STATE_UNKNOWN",
		1: "ASSIGNMENT_STATE_FENCING",
		2: "ASSIGNMENT_STATE_PERSIST_RECOVERING",
		3: "ASSIGNMENT_STATE_STREAM_RECOVERING",
	}
	AssignmentState_value = map[string]int32{
		"ASSIGNMENT_STATE_UNKNOWN":            0,
		"ASSIGNMENT_STATE_FENCING":            1,
		"ASSIGNMENT_STATE_PERSIST_RECOVERING": 2,
		"ASSIGNMENT_STATE_STREAM_RECOVERING":  3,
	}
)
...
// StreamRecoveringProgress contains progress information during stream recovery.
type StreamRecoveringProgress struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	RecoveredBytes    int64 `protobuf:"varint,1,opt,name=recovered_bytes,json=recoveredBytes,proto3" json:"recovered_bytes,omitempty"`
	TotalBytes        int64 `protobuf:"varint,2,opt,name=total_bytes,json=totalBytes,proto3" json:"total_bytes,omitempty"` // -1 if unknown
	RecoveredMessages int64 `protobuf:"varint,3,opt,name=recovered_messages,json=recoveredMessages,proto3" json:"recovered_messages,omitempty"`
	TotalMessages     int64 `protobuf:"varint,4,opt,name=total_messages,json=totalMessages,proto3" json:"total_messages,omitempty"` // -1 if unknown
}

func (x *StreamRecoveringProgress) Reset() {
	*x = StreamRecoveringProgress{}
	if protoimpl.UnsafeEnabled {
...
func (x *StreamRecoveringProgress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamRecoveringProgress) ProtoMessage() {}

func (x *StreamRecoveringProgress) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[68]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamRecoveringProgress.ProtoReflect.Descriptor instead.
func (*StreamRecoveringProgress) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{68}
}

func (x *StreamRecoveringProgress) GetRecoveredBytes() int64 {
	if x != nil {
		return x.RecoveredBytes
	}
	return 0
}

func (x *StreamRecoveringProgress) GetTotalBytes() int64 {
	if x != nil {
		return x.TotalBytes
	}
	return 0
...
func (x *StreamRecoveringProgress) GetRecoveredMessages() int64 {
	if x != nil {
		return x.RecoveredMessages
	}
	return 0
}

func (x *StreamRecoveringProgress) GetTotalMessages() int64 {
	if x != nil {
...
// AssignmentProgress reports the current state and progress of WAL assignment.
type AssignmentProgress struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	State                    AssignmentState           `protobuf:"varint,1,opt,name=state,proto3,enum=milvus.proto.streaming.AssignmentState" json:"state,omitempty"`
	StreamRecoveringProgress *StreamRecoveringProgress `protobuf:"bytes,2,opt,name=stream_recovering_progress,json=streamRecoveringProgress,proto3" json:"stream_recovering_progress,omitempty"` // Valid only in STREAM_RECOVERING
}
...
func (x *AssignmentProgress) GetState() AssignmentState {
	if x != nil {
		return x.State
	}
	return AssignmentState_ASSIGNMENT_STATE_UNKNOWN
}

func (x *AssignmentProgress) GetStreamRecoveringProgress() *StreamRecoveringProgress {
	if x != nil {
		return x.StreamRecoveringProgress
	}
	return nil
}

// AssignmentReady indicates the WAL assignment has completed successfully.
type AssignmentReady struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *AssignmentReady) Reset() {
	*x = AssignmentReady{}
	if protoimpl.UnsafeEnabled {
...
func (x *AssignmentReady) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AssignmentReady) ProtoMessage() {}

func (x *AssignmentReady) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[70]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AssignmentReady.ProtoReflect.Descriptor instead.
func (*AssignmentReady) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{70}
}

// AssignmentStateResponse is the response message for AssignWithStateReport RPC.
type AssignmentStateResponse struct {
	...
	// Types that are assignable to Response:
	//
	//	*AssignmentStateResponse_Progress
	//	*AssignmentStateResponse_Error
	//	*AssignmentStateResponse_Ready
	Response isAssignmentStateResponse_Response `protobuf_oneof:"response"`
}

func (x *AssignmentStateResponse) Reset() {
	*x = AssignmentStateResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *AssignmentStateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AssignmentStateResponse) ProtoMessage() {}

func (x *AssignmentStateResponse) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[71]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AssignmentStateResponse.ProtoReflect.Descriptor instead.
func (*AssignmentStateResponse) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{71}
}

func (m *AssignmentStateResponse) GetResponse() isAssignmentStateResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *AssignmentStateResponse) GetProgress() *AssignmentProgress {
	if x, ok := x.GetResponse().(*AssignmentStateResponse_Progress); ok {
		return x.Progress
	}
	return nil
}

func (x *AssignmentStateResponse) GetError() *StreamingError {
	if x, ok := x.GetResponse().(*AssignmentStateResponse_Error); ok {
		return x.Error
	}
	return nil
}

func (x *AssignmentStateResponse) GetReady() *AssignmentReady {
	if x, ok := x.GetResponse().(*AssignmentStateResponse_Ready); ok {
		return x.Ready
	}
	return nil
}

type isAssignmentStateResponse_Response interface {
	isAssignmentStateResponse_Response()
}

type AssignmentStateResponse_Progress struct {
	Progress *AssignmentProgress `protobuf:"bytes,1,opt,name=progress,proto3,oneof"` // Intermediate state: recovery progress
}

type AssignmentStateResponse_Error struct {
	Error *StreamingError `protobuf:"bytes,2,opt,name=error,proto3,oneof"` // Terminal state: failed
}

type AssignmentStateResponse_Ready struct {
	Ready *AssignmentReady `protobuf:"bytes,3,opt,name=ready,proto3,oneof"` // Terminal state: ready
}

func (*AssignmentStateResponse_Progress) isAssignmentStateResponse_Response() {}

func (*AssignmentStateResponse_Error) isAssignmentStateResponse_Response() {}

func (*AssignmentStateResponse_Ready) isAssignmentStateResponse_Response() {}
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x22, 0xba, 0x01, 0x0a, 0x18, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x63, 0x6f, 0x76,
	0x65, 0x72, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x27, 0x0a,
	0x0f, 0x72, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x72, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xca, 0x01, 0x0a, 0x1a, 0x52, 0x65, 0x70, 0x6c, 0x69,
	...
	0x75, 0x6c, 0x74, 0x22, 0xe6, 0x02, 0x0a, 0x15, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74,
	...
	0x05, 0x2a, 0xfb, 0x04, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x43,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x32, 0xc8, 0x04,
	...
	,
...
var file_streaming_proto_msgTypes = make([]protoimpl.MessageInfo, 84)
var file_streaming_proto_goTypes = []interface{}{
	...
	(AssignmentState)(0),                              // 4: milvus.proto.streaming.AssignmentState
	...
	(*ProduceMessageResponseResult)(nil),              // 52: milvus.proto.streaming.ProduceMessageResponseResult
	(*CloseProducerResponse)(nil),                     // 53: milvus.proto.streaming.CloseProducerResponse
	(*ConsumeRequest)(nil),                            // 54: milvus.proto.streaming.ConsumeRequest
	(*CloseConsumerRequest)(nil),                      // 55: milvus.proto.streaming.CloseConsumerRequest
	(*CreateConsumerRequest)(nil),                     // 56: milvus.proto.streaming.CreateConsumerRequest
	(*CreateVChannelConsumersRequest)(nil),            // 57: milvus.proto.streaming.CreateVChannelConsumersRequest
	(*CreateVChannelConsumerRequest)(nil),             // 58: milvus.proto.streaming.CreateVChannelConsumerRequest
	(*CreateVChannelConsumersResponse)(nil),           // 59: milvus.proto.streaming.CreateVChannelConsumersResponse
	(*CreateVChannelConsumerResponse)(nil),            // 60: milvus.proto.streaming.CreateVChannelConsumerResponse
	(*CloseVChannelConsumerRequest)(nil),              // 61: milvus.proto.streaming.CloseVChannelConsumerRequest
	(*CloseVChannelConsumerResponse)(nil),             // 62: milvus.proto.streaming.CloseVChannelConsumerResponse
	(*ConsumeResponse)(nil),                           // 63: milvus.proto.streaming.ConsumeResponse
	(*CreateConsumerResponse)(nil),                    // 64: milvus.proto.streaming.CreateConsumerResponse
	(*ConsumeMessageReponse)(nil),                     // 65: milvus.proto.streaming.ConsumeMessageReponse
	(*CloseConsumerResponse)(nil),                     // 66: milvus.proto.streaming.CloseConsumerResponse
	(*StreamingNodeManagerAssignRequest)(nil),         // 67: milvus.proto.streaming.StreamingNodeManagerAssignRequest
	(*StreamingNodeManagerAssignResponse)(nil),        // 68: milvus.proto.streaming.StreamingNodeManagerAssignResponse
	(*StreamingNodeManagerRemoveRequest)(nil),         // 69: milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	(*StreamingNodeManagerRemoveResponse)(nil),        // 70: milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	(*StreamingNodeManagerCollectStatusRequest)(nil),  // 71: milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	(*StreamingNodeMetrics)(nil),                      // 72: milvus.proto.streaming.StreamingNodeMetrics
	(*StreamingNodeWALMetrics)(nil),                   // 73: milvus.proto.streaming.StreamingNodeWALMetrics
	(*StreamingNodeRWWALMetrics)(nil),                 // 74: milvus.proto.streaming.StreamingNodeRWWALMetrics
	(*StreamingNodeROWALMetrics)(nil),                 // 75: milvus.proto.streaming.StreamingNodeROWALMetrics
	(*StreamingNodeManagerCollectStatusResponse)(nil), // 76: milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
	(*StreamRecoveringProgress)(nil),                  // 77: milvus.proto.streaming.StreamRecoveringProgress
	(*AssignmentProgress)(nil),                        // 78: milvus.proto.streaming.AssignmentProgress
	(*AssignmentReady)(nil),                           // 79: milvus.proto.streaming.AssignmentReady
	(*AssignmentStateResponse)(nil),                   // 80: milvus.proto.streaming.AssignmentStateResponse
	(*VChannelMeta)(nil),                              // 81: milvus.proto.streaming.VChannelMeta
	(*CollectionInfoOfVChannel)(nil),                  // 82: milvus.proto.streaming.CollectionInfoOfVChannel
	(*CollectionSchemaOfVChannel)(nil),                // 83: milvus.proto.streaming.CollectionSchemaOfVChannel
	(*PartitionInfoOfVChannel)(nil),                   // 84: milvus.proto.streaming.PartitionInfoOfVChannel
	(*SegmentAssignmentMeta)(nil),                     // 85: milvus.proto.streaming.SegmentAssignmentMeta
	(*SegmentAssignmentStat)(nil),                     // 86: milvus.proto.streaming.SegmentAssignmentStat
	(*WALCheckpoint)(nil),                             // 87: milvus.proto.streaming.WALCheckpoint
	(*AlterWALState)(nil),                             // 88: milvus.proto.streaming.AlterWALState
	(*ReplicateConfigurationMeta)(nil),                // 89: milvus.proto.streaming.ReplicateConfigurationMeta
	(*ReplicatePChannelMeta)(nil),                     // 90: milvus.proto.streaming.ReplicatePChannelMeta
	nil,                                               // 91: milvus.proto.streaming.BroadcastResponse.ResultsEntry
	nil,                                               // 92: milvus.proto.streaming.AlterWALState.ConfigsEntry
	(*messagespb.Message)(nil),                        // 93: milvus.proto.messages.Message
	(*commonpb.MessageID)(nil),                        // 94: milvus.proto.common.MessageID
	(*commonpb.ImmutableMessage)(nil),                 // 95: milvus.proto.common.ImmutableMessage
	(*commonpb.ReplicateConfiguration)(nil),           // 96: milvus.proto.common.ReplicateConfiguration
	(*fieldmaskpb.FieldMask)(nil),                     // 97: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),                             // 98: google.protobuf.Empty
	(messagespb.MessageType)(0),                       // 99: milvus.proto.messages.MessageType
	(*commonpb.ReplicateCheckpoint)(nil),              // 100: milvus.proto.common.ReplicateCheckpoint
	(*messagespb.TxnContext)(nil),                     // 101: milvus.proto.messages.TxnContext
	...
	(commonpb.WALName)(0),                             // 105: milvus.proto.common.WALName
	(*commonpb.MilvusCluster)(nil),                    // 106: milvus.proto.common.MilvusCluster
	(*milvuspb.GetComponentStatesRequest)(nil),        // 107: milvus.proto.milvus.GetComponentStatesRequest
	(*milvuspb.ComponentStates)(nil),                  // 108: milvus.proto.milvus.ComponentStates
}
var file_streaming_proto_depIdxs = []int32{
	...
	93,  // 7: milvus.proto.streaming.BroadcastTask.message:type_name -> milvus.proto.messages.Message
	...
	94,  // 11: milvus.proto.streaming.AckedCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	94,  // 12: milvus.proto.streaming.AckedCheckpoint.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	93,  // 13: milvus.proto.streaming.BroadcastRequest.message:type_name -> milvus.proto.messages.Message
	91,  // 14: milvus.proto.streaming.BroadcastResponse.results:type_name -> milvus.proto.streaming.BroadcastResponse.ResultsEntry
	95,  // 15: milvus.proto.streaming.BroadcastAckRequest.message:type_name -> milvus.proto.common.ImmutableMessage
	96,  // 16: milvus.proto.streaming.UpdateReplicateConfigurationRequest.configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	...
	97,  // 19: milvus.proto.streaming.UpdateWALBalancePolicyRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	96,  // 30: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	...
	98,  // 36: milvus.proto.streaming.DeliverPolicy.all:type_name -> google.protobuf.Empty
	98,  // 37: milvus.proto.streaming.DeliverPolicy.latest:type_name -> google.protobuf.Empty
	94,  // 38: milvus.proto.streaming.DeliverPolicy.start_from:type_name -> milvus.proto.common.MessageID
	94,  // 39: milvus.proto.streaming.DeliverPolicy.start_after:type_name -> milvus.proto.common.MessageID
	...
	99,  // 43: milvus.proto.streaming.DeliverFilterMessageType.message_types:type_name -> milvus.proto.messages.MessageType
	...
	100, // 46: milvus.proto.streaming.GetReplicateCheckpointResponse.checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	...
	93,  // 50: milvus.proto.streaming.ProduceMessageRequest.message:type_name -> milvus.proto.messages.Message
	...
	53,  // 53: milvus.proto.streaming.ProduceResponse.close:type_name -> milvus.proto.streaming.CloseProducerResponse
	52,  // 54: milvus.proto.streaming.ProduceMessageResponse.result:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	42,  // 55: milvus.proto.streaming.ProduceMessageResponse.error:type_name -> milvus.proto.streaming.StreamingError
	94,  // 56: milvus.proto.streaming.ProduceMessageResponseResult.id:type_name -> milvus.proto.common.MessageID
	101, // 57: milvus.proto.streaming.ProduceMessageResponseResult.txnContext:type_name -> milvus.proto.messages.TxnContext
	102, // 58: milvus.proto.streaming.ProduceMessageResponseResult.extra:type_name -> google.protobuf.Any
	94,  // 59: milvus.proto.streaming.ProduceMessageResponseResult.last_confirmed_id:type_name -> milvus.proto.common.MessageID
	58,  // 60: milvus.proto.streaming.ConsumeRequest.create_vchannel_consumer:type_name -> milvus.proto.streaming.CreateVChannelConsumerRequest
	57,  // 61: milvus.proto.streaming.ConsumeRequest.create_vchannel_consumers:type_name -> milvus.proto.streaming.CreateVChannelConsumersRequest
	61,  // 62: milvus.proto.streaming.ConsumeRequest.close_vchannel:type_name -> milvus.proto.streaming.CloseVChannelConsumerRequest
	55,  // 63: milvus.proto.streaming.ConsumeRequest.close:type_name -> milvus.proto.streaming.CloseConsumerRequest
	9,   // 64: milvus.proto.streaming.CreateConsumerRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	58,  // 65: milvus.proto.streaming.CreateVChannelConsumersRequest.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumerRequest
	37,  // 66: milvus.proto.streaming.CreateVChannelConsumerRequest.deliver_policy:type_name -> milvus.proto.streaming.DeliverPolicy
	38,  // 67: milvus.proto.streaming.CreateVChannelConsumerRequest.deliver_filters:type_name -> milvus.proto.streaming.DeliverFilter
	60,  // 68: milvus.proto.streaming.CreateVChannelConsumersResponse.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumerResponse
	42,  // 69: milvus.proto.streaming.CreateVChannelConsumerResponse.error:type_name -> milvus.proto.streaming.StreamingError
	64,  // 70: milvus.proto.streaming.ConsumeResponse.create:type_name -> milvus.proto.streaming.CreateConsumerResponse
	65,  // 71: milvus.proto.streaming.ConsumeResponse.consume:type_name -> milvus.proto.streaming.ConsumeMessageReponse
	60,  // 72: milvus.proto.streaming.ConsumeResponse.create_vchannel:type_name -> milvus.proto.streaming.CreateVChannelConsumerResponse
	59,  // 73: milvus.proto.streaming.ConsumeResponse.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumersResponse
	62,  // 74: milvus.proto.streaming.ConsumeResponse.close_vchannel:type_name -> milvus.proto.streaming.CloseVChannelConsumerResponse
	66,  // 75: milvus.proto.streaming.ConsumeResponse.close:type_name -> milvus.proto.streaming.CloseConsumerResponse
	95,  // 76: milvus.proto.streaming.ConsumeMessageReponse.message:type_name -> milvus.proto.common.ImmutableMessage
	9,   // 77: milvus.proto.streaming.StreamingNodeManagerAssignRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	9,   // 78: milvus.proto.streaming.StreamingNodeManagerRemoveRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	73,  // 79: milvus.proto.streaming.StreamingNodeMetrics.wals:type_name -> milvus.proto.streaming.StreamingNodeWALMetrics
	9,   // 80: milvus.proto.streaming.StreamingNodeWALMetrics.info:type_name -> milvus.proto.streaming.PChannelInfo
	74,  // 81: milvus.proto.streaming.StreamingNodeWALMetrics.rw:type_name -> milvus.proto.streaming.StreamingNodeRWWALMetrics
	75,  // 82: milvus.proto.streaming.StreamingNodeWALMetrics.ro:type_name -> milvus.proto.streaming.StreamingNodeROWALMetrics
	72,  // 83: milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse.metrics:type_name -> milvus.proto.streaming.StreamingNodeMetrics
	4,   // 84: milvus.proto.streaming.AssignmentProgress.state:type_name -> milvus.proto.streaming.AssignmentState
	77,  // 85: milvus.proto.streaming.AssignmentProgress.stream_recovering_progress:type_name -> milvus.proto.streaming.StreamRecoveringProgress
	78,  // 86: milvus.proto.streaming.AssignmentStateResponse.progress:type_name -> milvus.proto.streaming.AssignmentProgress
	42,  // 87: milvus.proto.streaming.AssignmentStateResponse.error:type_name -> milvus.proto.streaming.StreamingError
	79,  // 88: milvus.proto.streaming.AssignmentStateResponse.ready:type_name -> milvus.proto.streaming.AssignmentReady
	5,   // 89: milvus.proto.streaming.VChannelMeta.state:type_name -> milvus.proto.streaming.VChannelState
	82,  // 90: milvus.proto.streaming.VChannelMeta.collection_info:type_name -> milvus.proto.streaming.CollectionInfoOfVChannel
	84,  // 91: milvus.proto.streaming.CollectionInfoOfVChannel.partitions:type_name -> milvus.proto.streaming.PartitionInfoOfVChannel
	83,  // 92: milvus.proto.streaming.CollectionInfoOfVChannel.schemas:type_name -> milvus.proto.streaming.CollectionSchemaOfVChannel
	103, // 93: milvus.proto.streaming.CollectionSchemaOfVChannel.schema:type_name -> milvus.proto.schema.CollectionSchema
	6,   // 94: milvus.proto.streaming.CollectionSchemaOfVChannel.state:type_name -> milvus.proto.streaming.VChannelSchemaState
	7,   // 95: milvus.proto.streaming.SegmentAssignmentMeta.state:type_name -> milvus.proto.streaming.SegmentAssignmentState
	86,  // 96: milvus.proto.streaming.SegmentAssignmentMeta.stat:type_name -> milvus.proto.streaming.SegmentAssignmentStat
	104, // 97: milvus.proto.streaming.SegmentAssignmentStat.level:type_name -> milvus.proto.data.SegmentLevel
	94,  // 98: milvus.proto.streaming.WALCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	96,  // 99: milvus.proto.streaming.WALCheckpoint.replicate_config:type_name -> milvus.proto.common.ReplicateConfiguration
	100, // 100: milvus.proto.streaming.WALCheckpoint.replicate_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	88,  // 101: milvus.proto.streaming.WALCheckpoint.alter_wal_state:type_name -> milvus.proto.streaming.AlterWALState
	105, // 102: milvus.proto.streaming.AlterWALState.target_wal_name:type_name -> milvus.proto.common.WALName
	92,  // 103: milvus.proto.streaming.AlterWALState.configs:type_name -> milvus.proto.streaming.AlterWALState.ConfigsEntry
	8,   // 104: milvus.proto.streaming.AlterWALState.stage:type_name -> milvus.proto.streaming.AlterWALStage
	96,  // 105: milvus.proto.streaming.ReplicateConfigurationMeta.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	16,  // 106: milvus.proto.streaming.ReplicateConfigurationMeta.acked_result:type_name -> milvus.proto.streaming.AckedResult
	106, // 107: milvus.proto.streaming.ReplicatePChannelMeta.target_cluster:type_name -> milvus.proto.common.MilvusCluster
	100, // 108: milvus.proto.streaming.ReplicatePChannelMeta.initialized_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	52,  // 109: milvus.proto.streaming.BroadcastResponse.ResultsEntry.value:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	107, // 110: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	18,  // 111: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:input_type -> milvus.proto.streaming.BroadcastRequest
	20,  // 112: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:input_type -> milvus.proto.streaming.BroadcastAckRequest
	22,  // 113: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:input_type -> milvus.proto.streaming.UpdateReplicateConfigurationRequest
	24,  // 114: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:input_type -> milvus.proto.streaming.UpdateWALBalancePolicyRequest
	28,  // 115: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:input_type -> milvus.proto.streaming.AssignmentDiscoverRequest
	43,  // 116: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:input_type -> milvus.proto.streaming.GetReplicateCheckpointRequest
	45,  // 117: milvus.proto.streaming.StreamingNodeHandlerService.Produce:input_type -> milvus.proto.streaming.ProduceRequest
	54,  // 118: milvus.proto.streaming.StreamingNodeHandlerService.Consume:input_type -> milvus.proto.streaming.ConsumeRequest
	67,  // 119: milvus.proto.streaming.StreamingNodeManagerService.Assign:input_type -> milvus.proto.streaming.StreamingNodeManagerAssignRequest
	69,  // 120: milvus.proto.streaming.StreamingNodeManagerService.Remove:input_type -> milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	71,  // 121: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:input_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	67,  // 122: milvus.proto.streaming.StreamingNodeManagerService.AssignWithStateReport:input_type -> milvus.proto.streaming.StreamingNodeManagerAssignRequest
	108, // 123: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	19,  // 124: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:output_type -> milvus.proto.streaming.BroadcastResponse
	21,  // 125: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:output_type -> milvus.proto.streaming.BroadcastAckResponse
	23,  // 126: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:output_type -> milvus.proto.streaming.UpdateReplicateConfigurationResponse
	27,  // 127: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:output_type -> milvus.proto.streaming.UpdateWALBalancePolicyResponse
	31,  // 128: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:output_type -> milvus.proto.streaming.AssignmentDiscoverResponse
	44,  // 129: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:output_type -> milvus.proto.streaming.GetReplicateCheckpointResponse
	49,  // 130: milvus.proto.streaming.StreamingNodeHandlerService.Produce:output_type -> milvus.proto.streaming.ProduceResponse
	63,  // 131: milvus.proto.streaming.StreamingNodeHandlerService.Consume:output_type -> milvus.proto.streaming.ConsumeResponse
	68,  // 132: milvus.proto.streaming.StreamingNodeManagerService.Assign:output_type -> milvus.proto.streaming.StreamingNodeManagerAssignResponse
	70,  // 133: milvus.proto.streaming.StreamingNodeManagerService.Remove:output_type -> milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	76,  // 134: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:output_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
	80,  // 135: milvus.proto.streaming.StreamingNodeManagerService.AssignWithStateReport:output_type -> milvus.proto.streaming.AssignmentStateResponse
...
func file_streaming_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_streaming_proto_msgTypes[68].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamRecoveringProgress); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[71].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AssignmentStateResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_streaming_proto_msgTypes[71].OneofWrappers = []interface{}{
		(*AssignmentStateResponse_Progress)(nil),
		(*AssignmentStateResponse_Error)(nil),
		(*AssignmentStateResponse_Ready)(nil),
	}
	type x struct{}
