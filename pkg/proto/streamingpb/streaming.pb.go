...
type SegmentAssignmentMeta struct {
	...
	// Types that are assignable to PersistedStorage:
	//
	//	*SegmentAssignmentMeta_L1
	//	*SegmentAssignmentMeta_L0
	PersistedStorage isSegmentAssignmentMeta_PersistedStorage `protobuf_oneof:"persisted_storage"`
}
...
func (m *SegmentAssignmentMeta) GetPersistedStorage() isSegmentAssignmentMeta_PersistedStorage {
	if m != nil {
		return m.PersistedStorage
	}
	return nil
}

func (x *SegmentAssignmentMeta) GetL1() *L1SegmentPersistedStorage {
	if x, ok := x.GetPersistedStorage().(*SegmentAssignmentMeta_L1); ok {
		return x.L1
	}
	return nil
}

func (x *SegmentAssignmentMeta) GetL0() *L0SegmentPersistedStorage {
	if x, ok := x.GetPersistedStorage().(*SegmentAssignmentMeta_L0); ok {
		return x.L0
	}
	return nil
}

type isSegmentAssignmentMeta_PersistedStorage interface {
	isSegmentAssignmentMeta_PersistedStorage()
}

type SegmentAssignmentMeta_L1 struct {
	L1 *L1SegmentPersistedStorage `protobuf:"bytes,9,opt,name=l1,proto3,oneof"` // L1 segment persisted storage.
}

type SegmentAssignmentMeta_L0 struct {
	L0 *L0SegmentPersistedStorage `protobuf:"bytes,10,opt,name=l0,proto3,oneof"` // L0 segment persisted storage.
}

func (*SegmentAssignmentMeta_L1) isSegmentAssignmentMeta_PersistedStorage() {}

func (*SegmentAssignmentMeta_L0) isSegmentAssignmentMeta_PersistedStorage() {}
...
type L0SegmentPersistedStorage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DeltaBinlog []*datapb.FieldBinlog `protobuf:"bytes,1,rep,name=delta_binlog,json=deltaBinlog,proto3" json:"delta_binlog,omitempty"`
}

func (x *L0SegmentPersistedStorage) Reset() {
	*x = L0SegmentPersistedStorage{}
	if protoimpl.UnsafeEnabled {
...
func (x *L0SegmentPersistedStorage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*L0SegmentPersistedStorage) ProtoMessage() {}

func (x *L0SegmentPersistedStorage) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[75]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use L0SegmentPersistedStorage.ProtoReflect.Descriptor instead.
func (*L0SegmentPersistedStorage) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{75}
}

func (x *L0SegmentPersistedStorage) GetDeltaBinlog() []*datapb.FieldBinlog {
	if x != nil {
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x69, 0x63, 0x6b, 0x22, 0x9d, 0x04, 0x0a, 0x15, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e,
	...
	0x6d, 0x65, 0x54, 0x69, 0x63, 0x6b, 0x12, 0x43, 0x0a, 0x02, 0x6c, 0x31, 0x18, 0x09, 0x20, 0x01,
	...
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x48, 0x00, 0x52, 0x02, 0x6c, 0x31, 0x12, 0x43, 0x0a, 0x02, 0x6c,
	0x30, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67,
	0x2e, 0x4c, 0x30, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x50, 0x65, 0x72, 0x73, 0x69, 0x73,
	0x74, 0x65, 0x64, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x48, 0x00, 0x52, 0x02, 0x6c, 0x30,
	0x42, 0x13, 0x0a, 0x11, 0x70, 0x65, 0x72, 0x73, 0x69, 0x73, 0x74, 0x65, 0x64, 0x5f, 0x73, 0x74,
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x22, 0xd4, 0x01, 0x0a, 0x19, 0x4c, 0x31, 0x53, 0x65, 0x67, 0x6d,
	...
	0x22, 0x5e, 0x0a, 0x19, 0x4c, 0x30, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x50, 0x65, 0x72,
	0x73, 0x69, 0x73, 0x74, 0x65, 0x64, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x12, 0x41, 0x0a,
	0x0c, 0x64, 0x65, 0x6c, 0x74, 0x61, 0x5f, 0x62, 0x69, 0x6e, 0x6c, 0x6f, 0x67, 0x18, 0x01, 0x20,
	...
	0x22, 0xb6, 0x04, 0x0a, 0x15, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x73, 0x73, 0x69,
	...
	0x69, 0x6e, 0x61, 0x72, 0x79, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x2d, 0x0a, 0x10, 0x63, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x03, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x3a, 0x0a, 0x17, 0x6c, 0x61, 0x73, 0x74,
	0x5f, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x42, 0x02, 0x18, 0x01, 0x52, 0x15, 0x6c,
	...
	,
	...
	0x54, 0x4f, 0x4e, 0x45, 0x10, 0x05, 0x2a, 0xcf, 0x04, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61,
	...
	0x5f, 0x4d, 0x49, 0x53, 0x4d, 0x41, 0x54, 0x43, 0x48, 0x10, 0x0e, 0x12, 0x1b, 0x0a, 0x16, 0x53,
...
var file_streaming_proto_goTypes = []interface{}{
	...
	(*L1SegmentPersistedStorage)(nil),                 // 81: milvus.proto.streaming.L1SegmentPersistedStorage
	(*L1SegmentBinLogs)(nil),                          // 82: milvus.proto.streaming.L1SegmentBinLogs
	(*L0SegmentPersistedStorage)(nil),                 // 83: milvus.proto.streaming.L0SegmentPersistedStorage
	(*SegmentAssignmentStat)(nil),                     // 84: milvus.proto.streaming.SegmentAssignmentStat
	(*WALCheckpoint)(nil),                             // 85: milvus.proto.streaming.WALCheckpoint
	(*AlterWALState)(nil),                             // 86: milvus.proto.streaming.AlterWALState
	(*ReplicateConfigurationMeta)(nil),                // 87: milvus.proto.streaming.ReplicateConfigurationMeta
	(*ReplicatePChannelMeta)(nil),                     // 88: milvus.proto.streaming.ReplicatePChannelMeta
	nil,                                               // 89: milvus.proto.streaming.BroadcastResponse.ResultsEntry
	nil,                                               // 90: milvus.proto.streaming.AlterWALState.ConfigsEntry
	(*messagespb.Message)(nil),                        // 91: milvus.proto.messages.Message
	(*commonpb.MessageID)(nil),                        // 92: milvus.proto.common.MessageID
	(*commonpb.ImmutableMessage)(nil),                 // 93: milvus.proto.common.ImmutableMessage
	(*commonpb.ReplicateConfiguration)(nil),           // 94: milvus.proto.common.ReplicateConfiguration
	(*fieldmaskpb.FieldMask)(nil),                     // 95: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),                             // 96: google.protobuf.Empty
	(messagespb.MessageType)(0),                       // 97: milvus.proto.messages.MessageType
	(*commonpb.ReplicateCheckpoint)(nil),              // 98: milvus.proto.common.ReplicateCheckpoint
	(*messagespb.TxnContext)(nil),                     // 99: milvus.proto.messages.TxnContext
	(*anypb.Any)(nil),                                 // 100: google.protobuf.Any
	(*schemapb.CollectionSchema)(nil),                 // 101: milvus.proto.schema.CollectionSchema
	(*datapb.FieldBinlog)(nil),                        // 102: milvus.proto.data.FieldBinlog
...
var file_streaming_proto_depIdxs = []int32{
	...
	91,  // 7: milvus.proto.streaming.BroadcastTask.message:type_name -> milvus.proto.messages.Message
	...
	92,  // 11: milvus.proto.streaming.AckedCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	92,  // 12: milvus.proto.streaming.AckedCheckpoint.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	91,  // 13: milvus.proto.streaming.BroadcastRequest.message:type_name -> milvus.proto.messages.Message
	89,  // 14: milvus.proto.streaming.BroadcastResponse.results:type_name -> milvus.proto.streaming.BroadcastResponse.ResultsEntry
	93,  // 15: milvus.proto.streaming.BroadcastAckRequest.message:type_name -> milvus.proto.common.ImmutableMessage
	94,  // 16: milvus.proto.streaming.UpdateReplicateConfigurationRequest.configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	...
	95,  // 19: milvus.proto.streaming.UpdateWALBalancePolicyRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	94,  // 30: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	...
	96,  // 36: milvus.proto.streaming.DeliverPolicy.all:type_name -> google.protobuf.Empty
	96,  // 37: milvus.proto.streaming.DeliverPolicy.latest:type_name -> google.protobuf.Empty
	92,  // 38: milvus.proto.streaming.DeliverPolicy.start_from:type_name -> milvus.proto.common.MessageID
	92,  // 39: milvus.proto.streaming.DeliverPolicy.start_after:type_name -> milvus.proto.common.MessageID
	...
	97,  // 43: milvus.proto.streaming.DeliverFilterMessageType.message_types:type_name -> milvus.proto.messages.MessageType
	...
	98,  // 46: milvus.proto.streaming.GetReplicateCheckpointResponse.checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	...
	91,  // 50: milvus.proto.streaming.ProduceMessageRequest.message:type_name -> milvus.proto.messages.Message
	...
	92,  // 56: milvus.proto.streaming.ProduceMessageResponseResult.id:type_name -> milvus.proto.common.MessageID
	99,  // 57: milvus.proto.streaming.ProduceMessageResponseResult.txnContext:type_name -> milvus.proto.messages.TxnContext
	100, // 58: milvus.proto.streaming.ProduceMessageResponseResult.extra:type_name -> google.protobuf.Any
	92,  // 59: milvus.proto.streaming.ProduceMessageResponseResult.last_confirmed_id:type_name -> milvus.proto.common.MessageID
	...
	93,  // 76: milvus.proto.streaming.ConsumeMessageReponse.message:type_name -> milvus.proto.common.ImmutableMessage
	...
	101, // 88: milvus.proto.streaming.CollectionSchemaOfVChannel.schema:type_name -> milvus.proto.schema.CollectionSchema
	...
	84,  // 91: milvus.proto.streaming.SegmentAssignmentMeta.stat:type_name -> milvus.proto.streaming.SegmentAssignmentStat
	81,  // 92: milvus.proto.streaming.SegmentAssignmentMeta.l1:type_name -> milvus.proto.streaming.L1SegmentPersistedStorage
	83,  // 93: milvus.proto.streaming.SegmentAssignmentMeta.l0:type_name -> milvus.proto.streaming.L0SegmentPersistedStorage
	82,  // 94: milvus.proto.streaming.L1SegmentPersistedStorage.binlogs:type_name -> milvus.proto.streaming.L1SegmentBinLogs
	102, // 95: milvus.proto.streaming.L1SegmentPersistedStorage.merged_stats_binlog:type_name -> milvus.proto.data.FieldBinlog
	102, // 96: milvus.proto.streaming.L1SegmentBinLogs.field_binlog:type_name -> milvus.proto.data.FieldBinlog
	102, // 97: milvus.proto.streaming.L1SegmentBinLogs.stats_binlog:type_name -> milvus.proto.data.FieldBinlog
	102, // 98: milvus.proto.streaming.L1SegmentBinLogs.bm25_binlog:type_name -> milvus.proto.data.FieldBinlog
	102, // 99: milvus.proto.streaming.L0SegmentPersistedStorage.delta_binlog:type_name -> milvus.proto.data.FieldBinlog
	103, // 100: milvus.proto.streaming.SegmentAssignmentStat.level:type_name -> milvus.proto.data.SegmentLevel
	92,  // 101: milvus.proto.streaming.WALCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	94,  // 102: milvus.proto.streaming.WALCheckpoint.replicate_config:type_name -> milvus.proto.common.ReplicateConfiguration
	98,  // 103: milvus.proto.streaming.WALCheckpoint.replicate_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	86,  // 104: milvus.proto.streaming.WALCheckpoint.alter_wal_state:type_name -> milvus.proto.streaming.AlterWALState
	104, // 105: milvus.proto.streaming.AlterWALState.target_wal_name:type_name -> milvus.proto.common.WALName
	90,  // 106: milvus.proto.streaming.AlterWALState.configs:type_name -> milvus.proto.streaming.AlterWALState.ConfigsEntry
	7,   // 107: milvus.proto.streaming.AlterWALState.stage:type_name -> milvus.proto.streaming.AlterWALStage
	94,  // 108: milvus.proto.streaming.ReplicateConfigurationMeta.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	15,  // 109: milvus.proto.streaming.ReplicateConfigurationMeta.acked_result:type_name -> milvus.proto.streaming.AckedResult
	105, // 110: milvus.proto.streaming.ReplicatePChannelMeta.target_cluster:type_name -> milvus.proto.common.MilvusCluster
	98,  // 111: milvus.proto.streaming.ReplicatePChannelMeta.initialized_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	51,  // 112: milvus.proto.streaming.BroadcastResponse.ResultsEntry.value:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	106, // 113: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	17,  // 114: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:input_type -> milvus.proto.streaming.BroadcastRequest
	19,  // 115: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:input_type -> milvus.proto.streaming.BroadcastAckRequest
	21,  // 116: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:input_type -> milvus.proto.streaming.UpdateReplicateConfigurationRequest
	23,  // 117: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:input_type -> milvus.proto.streaming.UpdateWALBalancePolicyRequest
	27,  // 118: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:input_type -> milvus.proto.streaming.AssignmentDiscoverRequest
	42,  // 119: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:input_type -> milvus.proto.streaming.GetReplicateCheckpointRequest
	44,  // 120: milvus.proto.streaming.StreamingNodeHandlerService.Produce:input_type -> milvus.proto.streaming.ProduceRequest
	53,  // 121: milvus.proto.streaming.StreamingNodeHandlerService.Consume:input_type -> milvus.proto.streaming.ConsumeRequest
	66,  // 122: milvus.proto.streaming.StreamingNodeManagerService.Assign:input_type -> milvus.proto.streaming.StreamingNodeManagerAssignRequest
	68,  // 123: milvus.proto.streaming.StreamingNodeManagerService.Remove:input_type -> milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	70,  // 124: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:input_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	107, // 125: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	18,  // 126: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:output_type -> milvus.proto.streaming.BroadcastResponse
	20,  // 127: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:output_type -> milvus.proto.streaming.BroadcastAckResponse
	22,  // 128: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:output_type -> milvus.proto.streaming.UpdateReplicateConfigurationResponse
	26,  // 129: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:output_type -> milvus.proto.streaming.UpdateWALBalancePolicyResponse
	30,  // 130: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:output_type -> milvus.proto.streaming.AssignmentDiscoverResponse
	43,  // 131: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:output_type -> milvus.proto.streaming.GetReplicateCheckpointResponse
	48,  // 132: milvus.proto.streaming.StreamingNodeHandlerService.Produce:output_type -> milvus.proto.streaming.ProduceResponse
	62,  // 133: milvus.proto.streaming.StreamingNodeHandlerService.Consume:output_type -> milvus.proto.streaming.ConsumeResponse
	67,  // 134: milvus.proto.streaming.StreamingNodeManagerService.Assign:output_type -> milvus.proto.streaming.StreamingNodeManagerAssignResponse
	69,  // 135: milvus.proto.streaming.StreamingNodeManagerService.Remove:output_type -> milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	75,  // 136: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:output_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
...
func file_streaming_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_streaming_proto_msgTypes[75].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*L0SegmentPersistedStorage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_streaming_proto_msgTypes[72].OneofWrappers = []interface{}{
		(*SegmentAssignmentMeta_L1)(nil),
		(*SegmentAssignmentMeta_L0)(nil),
	}
	type x struct{}
