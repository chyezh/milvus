...
type PChannelInfo struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`  // channel name, immutable attribute.
	...
	// recovered or moved to another streamingnode or the access mode is changed, the term
...
// SyncAssignmentRequest is the sync request message of Sync RPC.
type SyncAssignmentRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Assigned   []*PChannelInfo `protobuf:"bytes,1,rep,name=assigned,proto3" json:"assigned,omitempty"`
	Unassigned []*PChannelInfo `protobuf:"bytes,2,rep,name=unassigned,proto3" json:"unassigned,omitempty"`
}

func (x *SyncAssignmentRequest) Reset() {
	*x = SyncAssignmentRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SyncAssignmentRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncAssignmentRequest) ProtoMessage() {}

func (x *SyncAssignmentRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[45]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncAssignmentRequest.ProtoReflect.Descriptor instead.
func (*SyncAssignmentRequest) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{45}
}

func (x *SyncAssignmentRequest) GetAssigned() []*PChannelInfo {
	if x != nil {
		return x.Assigned
	}
	return nil
...
func (x *SyncAssignmentRequest) GetUnassigned() []*PChannelInfo {
	if x != nil {
		return x.Unassigned
	}
	return nil
...
// SyncCloseRequest is the close request message of Sync RPC.
...
// StreamingNodeManagerSyncRequest is the request message of Sync RPC.
type StreamingNodeManagerSyncRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Request:
	//
	//	*StreamingNodeManagerSyncRequest_Assignment
	//	*StreamingNodeManagerSyncRequest_Close
	Request isStreamingNodeManagerSyncRequest_Request `protobuf_oneof:"request"`
}

func (x *StreamingNodeManagerSyncRequest) Reset() {
	*x = StreamingNodeManagerSyncRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *StreamingNodeManagerSyncRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamingNodeManagerSyncRequest) ProtoMessage() {}

func (x *StreamingNodeManagerSyncRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[47]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamingNodeManagerSyncRequest.ProtoReflect.Descriptor instead.
func (*StreamingNodeManagerSyncRequest) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{47}
}

func (m *StreamingNodeManagerSyncRequest) GetRequest() isStreamingNodeManagerSyncRequest_Request {
	if m != nil {
		return m.Request
	}
	return nil
...
func (x *StreamingNodeManagerSyncRequest) GetAssignment() *SyncAssignmentRequest {
	if x, ok := x.GetRequest().(*StreamingNodeManagerSyncRequest_Assignment); ok {
		return x.Assignment
	}
	return nil
}

func (x *StreamingNodeManagerSyncRequest) GetClose() *SyncCloseRequest {
	if x, ok := x.GetRequest().(*StreamingNodeManagerSyncRequest_Close); ok {
		return x.Close
	}
	return nil
}

type isStreamingNodeManagerSyncRequest_Request interface {
	isStreamingNodeManagerSyncRequest_Request()
}

type StreamingNodeManagerSyncRequest_Assignment struct {
	Assignment *SyncAssignmentRequest `protobuf:"bytes,1,opt,name=assignment,proto3,oneof"`
}

type StreamingNodeManagerSyncRequest_Close struct {
	Close *SyncCloseRequest `protobuf:"bytes,2,opt,name=close,proto3,oneof"`
}

func (*StreamingNodeManagerSyncRequest_Assignment) isStreamingNodeManagerSyncRequest_Request() {}

func (*StreamingNodeManagerSyncRequest_Close) isStreamingNodeManagerSyncRequest_Request() {}

// StreamingNodeBalanceAttributes is the balance attributes of a streaming node.
...
// StreamingNodeManagerSyncResponse is the response message of Sync RPC.
type StreamingNodeManagerSyncResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Response:
	//
	//	*StreamingNodeManagerSyncResponse_Assignment
	//	*StreamingNodeManagerSyncResponse_Close
	Response isStreamingNodeManagerSyncResponse_Response `protobuf_oneof:"response"`
}

func (x *StreamingNodeManagerSyncResponse) Reset() {
	*x = StreamingNodeManagerSyncResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *StreamingNodeManagerSyncResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamingNodeManagerSyncResponse) ProtoMessage() {}

func (x *StreamingNodeManagerSyncResponse) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[49]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamingNodeManagerSyncResponse.ProtoReflect.Descriptor instead.
func (*StreamingNodeManagerSyncResponse) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{49}
}

func (m *StreamingNodeManagerSyncResponse) GetResponse() isStreamingNodeManagerSyncResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *StreamingNodeManagerSyncResponse) GetAssignment() *SyncAssignmentResponse {
	if x, ok := x.GetResponse().(*StreamingNodeManagerSyncResponse_Assignment); ok {
		return x.Assignment
	}
	return nil
}

func (x *StreamingNodeManagerSyncResponse) GetClose() *SyncCloseResponse {
	if x, ok := x.GetResponse().(*StreamingNodeManagerSyncResponse_Close); ok {
		return x.Close
	}
	return nil
}

type isStreamingNodeManagerSyncResponse_Response interface {
	isStreamingNodeManagerSyncResponse_Response()
}

type StreamingNodeManagerSyncResponse_Assignment struct {
	Assignment *SyncAssignmentResponse `protobuf:"bytes,1,opt,name=assignment,proto3,oneof"`
}

type StreamingNodeManagerSyncResponse_Close struct {
	Close *SyncCloseResponse `protobuf:"bytes,2,opt,name=close,proto3,oneof"`
}

func (*StreamingNodeManagerSyncResponse_Assignment) isStreamingNodeManagerSyncResponse_Response() {}

func (*StreamingNodeManagerSyncResponse_Close) isStreamingNodeManagerSyncResponse_Response() {}

// SyncCloseResponse is the close response message of Sync RPC.
...
// SyncAssignmentResponse is the sync response message of Sync RPC.
type SyncAssignmentResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Assigned          []*SyncAssignmentResult         `protobuf:"bytes,1,rep,name=assigned,proto3" json:"assigned,omitempty"`
	Unassigned        []*PChannelInfo                 `protobuf:"bytes,2,rep,name=unassigned,proto3" json:"unassigned,omitempty"`
	BalanceAttributes *StreamingNodeBalanceAttributes `protobuf:"bytes,3,opt,name=balance_attributes,json=balanceAttributes,proto3" json:"balance_attributes,omitempty"`
}

func (x *SyncAssignmentResponse) Reset() {
	*x = SyncAssignmentResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SyncAssignmentResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncAssignmentResponse) ProtoMessage() {}

func (x *SyncAssignmentResponse) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[51]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncAssignmentResponse.ProtoReflect.Descriptor instead.
func (*SyncAssignmentResponse) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{51}
}

func (x *SyncAssignmentResponse) GetAssigned() []*SyncAssignmentResult {
	if x != nil {
		return x.Assigned
	}
	return nil
...
func (x *SyncAssignmentResponse) GetUnassigned() []*PChannelInfo {
	if x != nil {
		return x.Unassigned
	}
	return nil
...
func (x *SyncAssignmentResponse) GetBalanceAttributes() *StreamingNodeBalanceAttributes {
	if x != nil {
...
// SyncAssignmentResult is the result of the sync assignment.
type SyncAssignmentResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Pchannel *PChannelInfo   `protobuf:"bytes,1,opt,name=pchannel,proto3" json:"pchannel,omitempty"`
	Error    *StreamingError `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
}

func (x *SyncAssignmentResult) Reset() {
	*x = SyncAssignmentResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *SyncAssignmentResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncAssignmentResult) ProtoMessage() {}

func (x *SyncAssignmentResult) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[52]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncAssignmentResult.ProtoReflect.Descriptor instead.
func (*SyncAssignmentResult) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{52}
}

func (x *SyncAssignmentResult) GetPchannel() *PChannelInfo {
	if x != nil {
		return x.Pchannel
	}
	return nil
...
func (x *SyncAssignmentResult) GetError() *StreamingError {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_streaming_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x65, 0x73, 0x52, 0x11, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x41, 0x74, 0x74, 0x72, 0x69,
	0x62, 0x75, 0x74, 0x65, 0x73, 0x22, 0x96, 0x01, 0x0a, 0x14, 0x53, 0x79, 0x6e, 0x63, 0x41, 0x73,
	0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x40,
	...
	0x6e, 0x67, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xcc,
	...
	0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x87, 0x03,
	...
	,
	...
	0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x20, 0x6c, 0x61, 0x73, 0x74, 0x4d, 0x6f, 0x64, 0x69, 0x66,
	0x69, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x4e, 0x61, 0x6e, 0x6f,
	0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x62, 0x69, 0x6e, 0x6c, 0x6f,
	...
	0x69, 0x6d, 0x65, 0x54, 0x69, 0x63, 0x6b, 0x22, 0x4f, 0x0a, 0x0d, 0x57, 0x41, 0x4c, 0x43, 0x68,
	0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x3e, 0x0a, 0x09, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x6d, 0x69,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x44, 0x2a, 0x51, 0x0a, 0x12, 0x50, 0x43, 0x68, 0x61,
	...
	0x41, 0x54, 0x45, 0x5f, 0x46, 0x4c, 0x55, 0x53, 0x48, 0x45, 0x44, 0x10, 0x04, 0x32, 0x89, 0x01,
	...
	0x73, 0x65, 0x22, 0x00, 0x32, 0xa5, 0x01, 0x0a, 0x1f, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69,
	0x6e, 0x67, 0x43, 0x6f, 0x6f, 0x72, 0x64, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e,
	0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x81, 0x01, 0x0a, 0x12, 0x41, 0x73, 0x73,
	...
	0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x32, 0xe1, 0x01, 0x0a,
	0x1b, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65, 0x48, 0x61,
	0x6e, 0x64, 0x6c, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x60, 0x0a, 0x07,
	...
	,
...
var file_streaming_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_streaming_proto_goTypes = []interface{}{
	...
	(*SyncAssignmentRequest)(nil),                  // 50: milvus.proto.streaming.SyncAssignmentRequest
	(*SyncCloseRequest)(nil),                       // 51: milvus.proto.streaming.SyncCloseRequest
	(*StreamingNodeManagerSyncRequest)(nil),        // 52: milvus.proto.streaming.StreamingNodeManagerSyncRequest
	(*StreamingNodeBalanceAttributes)(nil),         // 53: milvus.proto.streaming.StreamingNodeBalanceAttributes
	(*StreamingNodeManagerSyncResponse)(nil),       // 54: milvus.proto.streaming.StreamingNodeManagerSyncResponse
	(*SyncCloseResponse)(nil),                      // 55: milvus.proto.streaming.SyncCloseResponse
	(*SyncAssignmentResponse)(nil),                 // 56: milvus.proto.streaming.SyncAssignmentResponse
	(*SyncAssignmentResult)(nil),                   // 57: milvus.proto.streaming.SyncAssignmentResult
	(*SegmentAssignmentMeta)(nil),                  // 58: milvus.proto.streaming.SegmentAssignmentMeta
	(*SegmentAssignmentStat)(nil),                  // 59: milvus.proto.streaming.SegmentAssignmentStat
	(*WALCheckpoint)(nil),                          // 60: milvus.proto.streaming.WALCheckpoint
	nil,                                            // 61: milvus.proto.streaming.BroadcastResponse.ResultsEntry
	(*messagespb.Message)(nil),                     // 62: milvus.proto.messages.Message
	(*emptypb.Empty)(nil),                          // 63: google.protobuf.Empty
	(*messagespb.MessageID)(nil),                   // 64: milvus.proto.messages.MessageID
	(messagespb.MessageType)(0),                    // 65: milvus.proto.messages.MessageType
	(*messagespb.TxnContext)(nil),                  // 66: milvus.proto.messages.TxnContext
	(*anypb.Any)(nil),                              // 67: google.protobuf.Any
	(*messagespb.ImmutableMessage)(nil),            // 68: milvus.proto.messages.ImmutableMessage
	(*milvuspb.GetComponentStatesRequest)(nil),     // 69: milvus.proto.milvus.GetComponentStatesRequest
...
var file_streaming_proto_depIdxs = []int32{
	...
	62, // 7: milvus.proto.streaming.BroadcastTask.message:type_name -> milvus.proto.messages.Message
	2,  // 8: milvus.proto.streaming.BroadcastTask.state:type_name -> milvus.proto.streaming.BroadcastTaskState
	62, // 9: milvus.proto.streaming.BroadcastRequest.message:type_name -> milvus.proto.messages.Message
	61, // 10: milvus.proto.streaming.BroadcastResponse.results:type_name -> milvus.proto.streaming.BroadcastResponse.ResultsEntry
	...
	63, // 21: milvus.proto.streaming.DeliverPolicy.all:type_name -> google.protobuf.Empty
	63, // 22: milvus.proto.streaming.DeliverPolicy.latest:type_name -> google.protobuf.Empty
	64, // 23: milvus.proto.streaming.DeliverPolicy.start_from:type_name -> milvus.proto.messages.MessageID
	64, // 24: milvus.proto.streaming.DeliverPolicy.start_after:type_name -> milvus.proto.messages.MessageID
	...
	65, // 28: milvus.proto.streaming.DeliverFilterMessageType.message_types:type_name -> milvus.proto.messages.MessageType
	...
	62, // 33: milvus.proto.streaming.ProduceMessageRequest.message:type_name -> milvus.proto.messages.Message
	...
	64, // 39: milvus.proto.streaming.ProduceMessageResponseResult.id:type_name -> milvus.proto.messages.MessageID
	66, // 40: milvus.proto.streaming.ProduceMessageResponseResult.txnContext:type_name -> milvus.proto.messages.TxnContext
	67, // 41: milvus.proto.streaming.ProduceMessageResponseResult.extra:type_name -> google.protobuf.Any
	...
	68, // 58: milvus.proto.streaming.ConsumeMessageReponse.message:type_name -> milvus.proto.messages.ImmutableMessage
	5,  // 59: milvus.proto.streaming.SyncAssignmentRequest.assigned:type_name -> milvus.proto.streaming.PChannelInfo
	5,  // 60: milvus.proto.streaming.SyncAssignmentRequest.unassigned:type_name -> milvus.proto.streaming.PChannelInfo
	50, // 61: milvus.proto.streaming.StreamingNodeManagerSyncRequest.assignment:type_name -> milvus.proto.streaming.SyncAssignmentRequest
	51, // 62: milvus.proto.streaming.StreamingNodeManagerSyncRequest.close:type_name -> milvus.proto.streaming.SyncCloseRequest
	56, // 63: milvus.proto.streaming.StreamingNodeManagerSyncResponse.assignment:type_name -> milvus.proto.streaming.SyncAssignmentResponse
	55, // 64: milvus.proto.streaming.StreamingNodeManagerSyncResponse.close:type_name -> milvus.proto.streaming.SyncCloseResponse
	57, // 65: milvus.proto.streaming.SyncAssignmentResponse.assigned:type_name -> milvus.proto.streaming.SyncAssignmentResult
	5,  // 66: milvus.proto.streaming.SyncAssignmentResponse.unassigned:type_name -> milvus.proto.streaming.PChannelInfo
	53, // 67: milvus.proto.streaming.SyncAssignmentResponse.balance_attributes:type_name -> milvus.proto.streaming.StreamingNodeBalanceAttributes
	5,  // 68: milvus.proto.streaming.SyncAssignmentResult.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	27, // 69: milvus.proto.streaming.SyncAssignmentResult.error:type_name -> milvus.proto.streaming.StreamingError
	4,  // 70: milvus.proto.streaming.SegmentAssignmentMeta.state:type_name -> milvus.proto.streaming.SegmentAssignmentState
	59, // 71: milvus.proto.streaming.SegmentAssignmentMeta.stat:type_name -> milvus.proto.streaming.SegmentAssignmentStat
	64, // 72: milvus.proto.streaming.WALCheckpoint.messageID:type_name -> milvus.proto.messages.MessageID
	35, // 73: milvus.proto.streaming.BroadcastResponse.ResultsEntry.value:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	69, // 74: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	10, // 75: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:input_type -> milvus.proto.streaming.BroadcastRequest
	12, // 76: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:input_type -> milvus.proto.streaming.BroadcastAckRequest
	14, // 77: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:input_type -> milvus.proto.streaming.AssignmentDiscoverRequest
	28, // 78: milvus.proto.streaming.StreamingNodeHandlerService.Produce:input_type -> milvus.proto.streaming.ProduceRequest
	37, // 79: milvus.proto.streaming.StreamingNodeHandlerService.Consume:input_type -> milvus.proto.streaming.ConsumeRequest
	52, // 80: milvus.proto.streaming.StreamingNodeManagerService.Sync:input_type -> milvus.proto.streaming.StreamingNodeManagerSyncRequest
	70, // 81: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	11, // 82: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:output_type -> milvus.proto.streaming.BroadcastResponse
	13, // 83: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:output_type -> milvus.proto.streaming.BroadcastAckResponse
	17, // 84: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:output_type -> milvus.proto.streaming.AssignmentDiscoverResponse
	32, // 85: milvus.proto.streaming.StreamingNodeHandlerService.Produce:output_type -> milvus.proto.streaming.ProduceResponse
	46, // 86: milvus.proto.streaming.StreamingNodeHandlerService.Consume:output_type -> milvus.proto.streaming.ConsumeResponse
	54, // 87: milvus.proto.streaming.StreamingNodeManagerService.Sync:output_type -> milvus.proto.streaming.StreamingNodeManagerSyncResponse
...
func file_streaming_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_streaming_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SyncAssignmentRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[47].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingNodeManagerSyncRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[49].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingNodeManagerSyncResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[51].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SyncAssignmentResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[52].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SyncAssignmentResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_streaming_proto_msgTypes[47].OneofWrappers = []interface{}{
		(*StreamingNodeManagerSyncRequest_Assignment)(nil),
		(*StreamingNodeManagerSyncRequest_Close)(nil),
	}
	file_streaming_proto_msgTypes[49].OneofWrappers = []interface{}{
		(*StreamingNodeManagerSyncResponse_Assignment)(nil),
		(*StreamingNodeManagerSyncResponse_Close)(nil),
	}
	type x struct{}
