...
// Segment IDs use delta encoding for compact wire format:
//
//	Encoding: sort IDs ascending, store [base, delta1, delta2, ...]
//	Decoding: cumulative sum, i.e., id[i] = sum(deltas[0..i])
type DataViewOfPartition struct {
	...
	// Sealed segment IDs in this partition, delta-encoded and sorted ascending.
	SegmentIdDeltas []int64 `protobuf:"varint,2,rep,packed,name=segment_id_deltas,json=segmentIdDeltas,proto3" json:"segment_id_deltas,omitempty"`
}
...
func (x *DataViewOfPartition) GetSegmentIdDeltas() []int64 {
	if x != nil {
		return x.SegmentIdDeltas
	}
	return nil
}
...
//	Decoding: cumulative sum, i.e., id[i] = sum(deltas[0..i])
//
// Example: IDs [100, 103, 105, 200] → deltas [100, 3, 2, 95]
type QueryViewOfPartition struct {
	...
	PartitionId int64 `protobuf:"varint,1,opt,name=partition_id,json=partitionId,proto3" json:"partition_id,omitempty"`
	// All segment IDs in this partition, delta-encoded and sorted ascending.
	SegmentIdDeltas []int64 `protobuf:"varint,2,rep,packed,name=segment_id_deltas,json=segmentIdDeltas,proto3" json:"segment_id_deltas,omitempty"`
	// Subset of segment IDs that are in Ready state, delta-encoded and sorted ascending.
	...
	ReadySegmentIdDeltas []int64 `protobuf:"varint,3,rep,packed,name=ready_segment_id_deltas,json=readySegmentIdDeltas,proto3" json:"ready_segment_id_deltas,omitempty"`
}
...
func (x *QueryViewOfPartition) GetSegmentIdDeltas() []int64 {
	if x != nil {
		return x.SegmentIdDeltas
	}
	return nil
...
func (x *QueryViewOfPartition) GetReadySegmentIdDeltas() []int64 {
	if x != nil {
		return x.ReadySegmentIdDeltas
	}
	return nil
}
...
var file_view_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x6b, 0x22, 0x64, 0x0a, 0x13, 0x44, 0x61, 0x74, 0x61, 0x56, 0x69, 0x65, 0x77, 0x4f,
	...
	,
	...
	0x65, 0x52, 0x09, 0x71, 0x75, 0x65, 0x72, 0x79, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x52, 0x0a, 0x0e,
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x03,
	...
	0x65, 0x77, 0x4f, 0x66, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64,
	0x65, 0x52, 0x0d, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65,
	0x22, 0xa9, 0x02, 0x0a, 0x0d, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x69, 0x65, 0x77, 0x4d, 0x65,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x70, 0x6c, 0x69,
	...
	0x65, 0x6c, 0x12, 0x3d, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20,
	...
	,
	...
	0x9c, 0x01, 0x0a, 0x14, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x69, 0x65, 0x77, 0x4f, 0x66, 0x50,
	...
	0x70, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x11, 0x73,
	0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x5f, 0x64, 0x65, 0x6c, 0x74, 0x61, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0f, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49,
	0x64, 0x44, 0x65, 0x6c, 0x74, 0x61, 0x73, 0x12, 0x35, 0x0a, 0x17, 0x72, 0x65, 0x61, 0x64, 0x79,
	0x5f, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x5f, 0x64, 0x65, 0x6c, 0x74,
	0x61, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x03, 0x52, 0x14, 0x72, 0x65, 0x61, 0x64, 0x79, 0x53,
	0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x44, 0x65, 0x6c, 0x74, 0x61, 0x73, 0x22, 0x97,
	...
	0x63, 0x6b, 0x52, 0x06, 0x73, 0x68, 0x61, 0x72, 0x64, 0x73, 0x22, 0x7d, 0x0a, 0x15, 0x44, 0x61,
	...
	0x74, 0x69, 0x63, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x1d, 0x64, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x53, 0x74, 0x61, 0x72, 0x74, 0x41, 0x66, 0x74, 0x65,
	0x72, 0x54, 0x69, 0x6d, 0x65, 0x74, 0x69, 0x63, 0x6b, 0x22, 0x16, 0x0a, 0x14, 0x53, 0x79, 0x6e,
	0x63, 0x44, 0x61, 0x74, 0x61, 0x56, 0x69, 0x65, 0x77, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x20, 0x0a, 0x1e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f,
	0x64, 0x65, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75,
	0x74, 0x65, 0x73, 0x22, 0x5e, 0x0a, 0x1a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4e, 0x6f, 0x64, 0x65,
	...
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x55,
	0x73, 0x61, 0x67, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x64, 0x69, 0x73, 0x6b, 0x5f, 0x75, 0x73, 0x61,
	0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x64, 0x69, 0x73, 0x6b, 0x55, 0x73,
	0x61, 0x67, 0x65, 0x2a, 0xe7, 0x01, 0x0a, 0x0e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x69, 0x65,
	...
	0x74, 0x61, 0x74, 0x65, 0x44, 0x72, 0x6f, 0x70, 0x70, 0x65, 0x64, 0x10, 0x07, 0x32, 0xcc, 0x01,
	...
	0x76, 0x32, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x69, 0x65, 0x77, 0x70, 0x62, 0x62,
