...
// AssignWithStateReport provides a mock function with given fields: ctx, in, opts
func (_m *MockStreamingNodeManagerServiceClient) AssignWithStateReport(ctx context.Context, in *streamingpb.StreamingNodeManagerAssignRequest, opts ...grpc.CallOption) (streamingpb.StreamingNodeManagerService_AssignWithStateReportClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for AssignWithStateReport")
	}

	var r0 streamingpb.StreamingNodeManagerService_AssignWithStateReportClient
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *streamingpb.StreamingNodeManagerAssignRequest, ...grpc.CallOption) (streamingpb.StreamingNodeManagerService_AssignWithStateReportClient, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *streamingpb.StreamingNodeManagerAssignRequest, ...grpc.CallOption) streamingpb.StreamingNodeManagerService_AssignWithStateReportClient); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(streamingpb.StreamingNodeManagerService_AssignWithStateReportClient)
		}
	}
...
// MockStreamingNodeManagerServiceClient_AssignWithStateReport_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AssignWithStateReport'
type MockStreamingNodeManagerServiceClient_AssignWithStateReport_Call struct {
	*mock.Call
}

// AssignWithStateReport is a helper method to define mock.On call
//   - ctx context.Context
//   - in *streamingpb.StreamingNodeManagerAssignRequest
//   - opts ...grpc.CallOption
func (_e *MockStreamingNodeManagerServiceClient_Expecter) AssignWithStateReport(ctx interface{}, in interface{}, opts ...interface{}) *MockStreamingNodeManagerServiceClient_AssignWithStateReport_Call {
	return &MockStreamingNodeManagerServiceClient_AssignWithStateReport_Call{Call: _e.mock.On("AssignWithStateReport",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockStreamingNodeManagerServiceClient_AssignWithStateReport_Call) Run(run func(ctx context.Context, in *streamingpb.StreamingNodeManagerAssignRequest, opts ...grpc.CallOption)) *MockStreamingNodeManagerServiceClient_AssignWithStateReport_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockStreamingNodeManagerServiceClient_AssignWithStateReport_Call) Return(_a0 streamingpb.StreamingNodeManagerService_AssignWithStateReportClient, _a1 error) *MockStreamingNodeManagerServiceClient_AssignWithStateReport_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStreamingNodeManagerServiceClient_AssignWithStateReport_Call) RunAndReturn(run func(context.Context, *streamingpb.StreamingNodeManagerAssignRequest, ...grpc.CallOption) (streamingpb.StreamingNodeManagerService_AssignWithStateReportClient, error)) *MockStreamingNodeManagerServiceClient_AssignWithStateReport_Call {
	_c.Call.Return(run)
	return _c
}
