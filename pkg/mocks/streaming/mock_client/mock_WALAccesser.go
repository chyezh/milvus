...
func (_m *MockWALAccesser) AppendMessagesWithOption(ctx context.Context, opts client.AppendOption, msgs ...message.MutableMessage) types.AppendResponses {
	_va := make([]interface{}, len(msgs))
	for _i := range msgs {
		_va[_i] = msgs[_i]
	}
...
func (_c *MockWALAccesser_AppendMessagesWithOption_Call) Run(run func(ctx context.Context, opts client.AppendOption, msgs ...message.MutableMessage)) *MockWALAccesser_AppendMessagesWithOption_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWALAccesser_AppendMessagesWithOption_Call) RunAndReturn(run func(context.Context, client.AppendOption, ...message.MutableMessage) types.AppendResponses) *MockWALAccesser_AppendMessagesWithOption_Call {
	_c.Call.Return(run)
	return _c
}

// Broadcast provides a mock function with no fields
func (_m *MockWALAccesser) Broadcast() client.Broadcast {
	ret := _m.Called()
...
func (_c *MockWALAccesser_Broadcast_Call) Return(_a0 client.Broadcast) *MockWALAccesser_Broadcast_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWALAccesser_Broadcast_Call) RunAndReturn(run func() client.Broadcast) *MockWALAccesser_Broadcast_Call {
	_c.Call.Return(run)
	return _c
}

// Local provides a mock function with no fields
func (_m *MockWALAccesser) Local() client.Local {
	ret := _m.Called()
...
func (_c *MockWALAccesser_Local_Call) Return(_a0 client.Local) *MockWALAccesser_Local_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWALAccesser_Local_Call) RunAndReturn(run func() client.Local) *MockWALAccesser_Local_Call {
	_c.Call.Return(run)
	return _c
}

// RawAppend provides a mock function with given fields: ctx, msgs, opts
func (_m *MockWALAccesser) RawAppend(ctx context.Context, msgs message.MutableMessage, opts ...client.AppendOption) (*types.AppendResult, error) {
...
func (_c *MockWALAccesser_RawAppend_Call) Run(run func(ctx context.Context, msgs message.MutableMessage, opts ...client.AppendOption)) *MockWALAccesser_RawAppend_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWALAccesser_RawAppend_Call) RunAndReturn(run func(context.Context, message.MutableMessage, ...client.AppendOption) (*types.AppendResult, error)) *MockWALAccesser_RawAppend_Call {
	_c.Call.Return(run)
	return _c
}

// Read provides a mock function with given fields: ctx, opts
func (_m *MockWALAccesser) Read(ctx context.Context, opts client.ReadOption) client.Scanner {
...
func (_c *MockWALAccesser_Read_Call) Run(run func(ctx context.Context, opts client.ReadOption)) *MockWALAccesser_Read_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWALAccesser_Read_Call) Return(_a0 client.Scanner) *MockWALAccesser_Read_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWALAccesser_Read_Call) RunAndReturn(run func(context.Context, client.ReadOption) client.Scanner) *MockWALAccesser_Read_Call {
	_c.Call.Return(run)
	return _c
}

// Txn provides a mock function with given fields: ctx, opts
func (_m *MockWALAccesser) Txn(ctx context.Context, opts client.TxnOption) (client.Txn, error) {
	ret := _m.Called(ctx, opts)
...
func (_c *MockWALAccesser_Txn_Call) Run(run func(ctx context.Context, opts client.TxnOption)) *MockWALAccesser_Txn_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWALAccesser_Txn_Call) Return(_a0 client.Txn, _a1 error) *MockWALAccesser_Txn_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWALAccesser_Txn_Call) RunAndReturn(run func(context.Context, client.TxnOption) (client.Txn, error)) *MockWALAccesser_Txn_Call {
	_c.Call.Return(run)
	return _c
}
