...
import (
	coord "github.com/milvus-io/milvus/pkg/v2/streaming/client/coord"
...
func (_m *MockClient) Assignment() coord.AssignmentService {
	ret := _m.Called()
	...
	var r0 coord.AssignmentService
	if rf, ok := ret.Get(0).(func() coord.AssignmentService); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(coord.AssignmentService)
		}
	}
...
func (_c *MockClient_Assignment_Call) Return(_a0 coord.AssignmentService) *MockClient_Assignment_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_Assignment_Call) RunAndReturn(run func() coord.AssignmentService) *MockClient_Assignment_Call {
	_c.Call.Return(run)
	return _c
}

// Broadcast provides a mock function with no fields
func (_m *MockClient) Broadcast() coord.BroadcastService {
	ret := _m.Called()
	...
	var r0 coord.BroadcastService
	if rf, ok := ret.Get(0).(func() coord.BroadcastService); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(coord.BroadcastService)
		}
	}
...
func (_c *MockClient_Broadcast_Call) Return(_a0 coord.BroadcastService) *MockClient_Broadcast_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_Broadcast_Call) RunAndReturn(run func() coord.BroadcastService) *MockClient_Broadcast_Call {
	_c.Call.Return(run)
	return _c
}
