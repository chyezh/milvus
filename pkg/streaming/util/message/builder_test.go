...
func TestMutableBuilder(t *testing.T) {
	...
	log.Info(context.TODO(), "test", log.Object("msg", b))
...
func TestImmutableTxnBuilder(t *testing.T) {
	...
	log.Info(context.TODO(), "test", log.Object("msg", mutableMsg))
	...
	log.Info(context.TODO(), "test", log.Object("msg", immutableCommit))
	...
	log.Info(context.TODO(), "test", log.Object("msg", immutableTxnMsg))
}
