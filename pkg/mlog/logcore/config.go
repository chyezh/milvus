...
// BuildOptions builds zap options from config.
...
// Initialize initializes the config with default values for unset fields.
...
// DefaultLogMaxSize returns the default max size for a single log file in MB.
func DefaultLogMaxSize() int {
