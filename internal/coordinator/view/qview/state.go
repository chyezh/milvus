...
type (
	QueryViewNodeState viewpb.QueryViewNodeState
...
const (
	QueryViewNodeStatePreparing     = QueryViewNodeState(viewpb.QueryViewNodeState_QueryViewNodeStatePreparing)
	QueryViewNodeStateReady         = QueryViewNodeState(viewpb.QueryViewNodeState_QueryViewNodeStateReady)
	QueryViewNodeStateUnrecoverable = QueryViewNodeState(viewpb.QueryViewNodeState_QueryViewNodeStateUnrecoverable)
	...
	NodeSyncStateAcked                             // NodeState signal has been sent to node and acknowledged.
)
