...
func (s *VersionedState) ChannelAssignmentInfo() map[int64]*streamingpb.StreamingNodeAssignment {
	assignments := make(map[int64]*streamingpb.StreamingNodeAssignment)
	for _, v := range s.State.Addresses {
