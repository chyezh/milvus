...
func (bw *BulkPackWriterV3) writeInsertsIntoStorage(ctx context.Context,
	...
	return WriteManifestInsert(ctx, ManifestInsertWriteInput{
		Schema:              bw.schema,
		Record:              rec,
		BasePath:            basePath,
		Version:             version,
...
func (bw *BulkPackWriterV3) writeDelta(ctx context.Context, pack *SyncPack) (string, *datapb.FieldBinlog, error) {
	...
	deltaLog, _, err := WriteDelta(ctx, DeltaWriteInput{
...
func (bw *BulkPackWriterV3) writeStats(ctx context.Context, pack *SyncPack) (map[int64]*datapb.FieldBinlog, error) {
	...
	newManifest, size, err := WriteManifestPKStats(ctx, ManifestPKStatsWriteInput{
...
func (bw *BulkPackWriterV3) writeBM25Stasts(ctx context.Context, pack *SyncPack) (map[int64]*datapb.FieldBinlog, error) {
	...
	newManifest, size, err := WriteManifestBM25Stats(ctx, ManifestBM25StatsWriteInput{
		ManifestPath:  bw.manifestPath,
		StorageConfig: bw.storageConfig,
		ChunkManager:  bw.chunkManager,
		Allocator:     bw.allocator,
