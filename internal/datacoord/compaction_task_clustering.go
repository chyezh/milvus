...
func (t *clusteringCompactionTask) Process() bool {
	ctx := context.TODO()
	ctx = mlog.WithFields(ctx, mlog.Int64("triggerID", t.GetTaskProto().GetTriggerID()), mlog.Int64("PlanID", t.GetTaskProto().GetPlanID()), mlog.Int64("collectionID", t.GetTaskProto().GetCollectionID()))
...
func (t *clusteringCompactionTask) retryableProcess(ctx context.Context) error {
	...
	if err != nil {
		// retryable
		mlog.Warn(ctx, "fail to get collection", mlog.Int64("collectionID", t.GetTaskProto().GetCollectionID()), mlog.Err(err))
	...
	if coll == nil {
		...
		mlog.Warn(ctx, "collection not found, it may be dropped, stop clustering compaction task", mlog.Int64("collectionID", t.GetTaskProto().GetCollectionID()))
