...
// AlterCredential provides a mock function with given fields: ctx, msg
func (_m *IMetaTable) AlterCredential(ctx context.Context, msg message.SpecializedImmutableMessage[*messagespb.PutUserMessageHeader, *messagespb.PutUserMessageBody]) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, message.SpecializedImmutableMessage[*messagespb.PutUserMessageHeader, *messagespb.PutUserMessageBody]) error); ok {
		r0 = rf(ctx, msg)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - msg message.SpecializedImmutableMessage[*messagespb.PutUserMessageHeader,*messagespb.PutUserMessageBody]
func (_e *IMetaTable_Expecter) AlterCredential(ctx interface{}, msg interface{}) *IMetaTable_AlterCredential_Call {
	return &IMetaTable_AlterCredential_Call{Call: _e.mock.On("AlterCredential", ctx, msg)}
}

func (_c *IMetaTable_AlterCredential_Call) Run(run func(ctx context.Context, msg message.SpecializedImmutableMessage[*messagespb.PutUserMessageHeader, *messagespb.PutUserMessageBody])) *IMetaTable_AlterCredential_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(message.SpecializedImmutableMessage[*messagespb.PutUserMessageHeader, *messagespb.PutUserMessageBody]))
	})
	return _c
}
...
func (_c *IMetaTable_AlterCredential_Call) RunAndReturn(run func(context.Context, message.SpecializedImmutableMessage[*messagespb.PutUserMessageHeader, *messagespb.PutUserMessageBody]) error) *IMetaTable_AlterCredential_Call {
	_c.Call.Return(run)
	return _c
}
...
// DeleteCredential provides a mock function with given fields: ctx, msg
func (_m *IMetaTable) DeleteCredential(ctx context.Context, msg message.SpecializedImmutableMessage[*messagespb.DropUserMessageHeader, *messagespb.DropUserMessageBody]) error {
	ret := _m.Called(ctx, msg)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, message.SpecializedImmutableMessage[*messagespb.DropUserMessageHeader, *messagespb.DropUserMessageBody]) error); ok {
		r0 = rf(ctx, msg)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - msg message.SpecializedImmutableMessage[*messagespb.DropUserMessageHeader,*messagespb.DropUserMessageBody]
func (_e *IMetaTable_Expecter) DeleteCredential(ctx interface{}, msg interface{}) *IMetaTable_DeleteCredential_Call {
	return &IMetaTable_DeleteCredential_Call{Call: _e.mock.On("DeleteCredential", ctx, msg)}
}

func (_c *IMetaTable_DeleteCredential_Call) Run(run func(ctx context.Context, msg message.SpecializedImmutableMessage[*messagespb.DropUserMessageHeader, *messagespb.DropUserMessageBody])) *IMetaTable_DeleteCredential_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(message.SpecializedImmutableMessage[*messagespb.DropUserMessageHeader, *messagespb.DropUserMessageBody]))
	})
	return _c
}
...
func (_c *IMetaTable_DeleteCredential_Call) RunAndReturn(run func(context.Context, message.SpecializedImmutableMessage[*messagespb.DropUserMessageHeader, *messagespb.DropUserMessageBody]) error) *IMetaTable_DeleteCredential_Call {
	_c.Call.Return(run)
	return _c
}
