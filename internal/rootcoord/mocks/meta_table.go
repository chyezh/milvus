...
func (_m *IMetaTable) AlterCollection(ctx context.Context, result message.BroadcastResult[*messagespb.AlterCollectionMessageHeader, *messagespb.PutCollectionMessageBody]) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, message.BroadcastResult[*messagespb.AlterCollectionMessageHeader, *messagespb.PutCollectionMessageBody]) error); ok {
		r0 = rf(ctx, result)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - result message.BroadcastResult[*messagespb.AlterCollectionMessageHeader,*messagespb.PutCollectionMessageBody]
...
func (_c *IMetaTable_AlterCollection_Call) Run(run func(ctx context.Context, result message.BroadcastResult[*messagespb.AlterCollectionMessageHeader, *messagespb.PutCollectionMessageBody])) *IMetaTable_AlterCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(message.BroadcastResult[*messagespb.AlterCollectionMessageHeader, *messagespb.PutCollectionMessageBody]))
	})
	return _c
}
...
func (_c *IMetaTable_AlterCollection_Call) RunAndReturn(run func(context.Context, message.BroadcastResult[*messagespb.AlterCollectionMessageHeader, *messagespb.PutCollectionMessageBody]) error) *IMetaTable_AlterCollection_Call {
	_c.Call.Return(run)
	return _c
}
