...
func (_m *IMetaTable) AlterCollection(ctx context.Context, result message.BroadcastResult[*messagespb.PutCollectionMessageHeader, *messagespb.PutCollectionMessageBody]) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, message.BroadcastResult[*messagespb.PutCollectionMessageHeader, *messagespb.PutCollectionMessageBody]) error); ok {
		r0 = rf(ctx, result)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - result message.BroadcastResult[*messagespb.PutCollectionMessageHeader,*messagespb.PutCollectionMessageBody]
...
func (_c *IMetaTable_AlterCollection_Call) Run(run func(ctx context.Context, result message.BroadcastResult[*messagespb.PutCollectionMessageHeader, *messagespb.PutCollectionMessageBody])) *IMetaTable_AlterCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(message.BroadcastResult[*messagespb.PutCollectionMessageHeader, *messagespb.PutCollectionMessageBody]))
	})
	return _c
}
...
func (_c *IMetaTable_AlterCollection_Call) RunAndReturn(run func(context.Context, message.BroadcastResult[*messagespb.PutCollectionMessageHeader, *messagespb.PutCollectionMessageBody]) error) *IMetaTable_AlterCollection_Call {
	_c.Call.Return(run)
	return _c
}

// AlterCredential provides a mock function with given fields: ctx, result
func (_m *IMetaTable) AlterCredential(ctx context.Context, result message.BroadcastResult[*messagespb.PutUserMessageHeader, *messagespb.PutUserMessageBody]) error {
	ret := _m.Called(ctx, result)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, message.BroadcastResult[*messagespb.PutUserMessageHeader, *messagespb.PutUserMessageBody]) error); ok {
		r0 = rf(ctx, result)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - result message.BroadcastResult[*messagespb.PutUserMessageHeader,*messagespb.PutUserMessageBody]
...
func (_c *IMetaTable_AlterCredential_Call) Run(run func(ctx context.Context, result message.BroadcastResult[*messagespb.PutUserMessageHeader, *messagespb.PutUserMessageBody])) *IMetaTable_AlterCredential_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(message.BroadcastResult[*messagespb.PutUserMessageHeader, *messagespb.PutUserMessageBody]))
	})
	return _c
}
...
func (_c *IMetaTable_AlterCredential_Call) RunAndReturn(run func(context.Context, message.BroadcastResult[*messagespb.PutUserMessageHeader, *messagespb.PutUserMessageBody]) error) *IMetaTable_AlterCredential_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *IMetaTable) PutAlias(ctx context.Context, result message.BroadcastResult[*messagespb.PutAliasMessageHeader, *messagespb.PutAliasMessageBody]) error {
	ret := _m.Called(ctx, result)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, message.BroadcastResult[*messagespb.PutAliasMessageHeader, *messagespb.PutAliasMessageBody]) error); ok {
		r0 = rf(ctx, result)
	} else {
		r0 = ret.Error(0)
	}
...
// IMetaTable_PutAlias_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PutAlias'
type IMetaTable_PutAlias_Call struct {
	*mock.Call
}

// PutAlias is a helper method to define mock.On call
//   - ctx context.Context
//   - result message.BroadcastResult[*messagespb.PutAliasMessageHeader,*messagespb.PutAliasMessageBody]
func (_e *IMetaTable_Expecter) PutAlias(ctx interface{}, result interface{}) *IMetaTable_PutAlias_Call {
	return &IMetaTable_PutAlias_Call{Call: _e.mock.On("PutAlias", ctx, result)}
}

func (_c *IMetaTable_PutAlias_Call) Run(run func(ctx context.Context, result message.BroadcastResult[*messagespb.PutAliasMessageHeader, *messagespb.PutAliasMessageBody])) *IMetaTable_PutAlias_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(message.BroadcastResult[*messagespb.PutAliasMessageHeader, *messagespb.PutAliasMessageBody]))
	})
	return _c
}

func (_c *IMetaTable_PutAlias_Call) Return(_a0 error) *IMetaTable_PutAlias_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *IMetaTable_PutAlias_Call) RunAndReturn(run func(context.Context, message.BroadcastResult[*messagespb.PutAliasMessageHeader, *messagespb.PutAliasMessageBody]) error) *IMetaTable_PutAlias_Call {
	_c.Call.Return(run)
	return _c
}
