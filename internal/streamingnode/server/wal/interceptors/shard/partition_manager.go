...
type partitionManager struct {
	...
	ctx                  context.Context
	txnManager           *txn.TxnManager // the txn manager is used to manage the transaction of the segment.
	wal                  *syncutil.Future[wal.WAL]
	pchannel             types.PChannelInfo
	vchannel             string
	collectionID         int64
...
// CollectionID returns the collection ID of the partition segment manager.
func (m *partitionManager) CollectionID() int64 {
...
// FlushPartition flushes all segments in the partition.
...
func (m *partitionManager) FlushPartition(policy policy.SealPolicy) []int64 {
