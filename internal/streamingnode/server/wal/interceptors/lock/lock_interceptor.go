...
// acqiureLockGuard acquires the lock for the vchannel and return a function as a guard.
func (r *lockAppendInterceptor) acqiureLockGuard(_ context.Context, msg message.MutableMessage) func() {
