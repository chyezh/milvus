...
func newSamplingTruncator(checkpoint *WALCheckpoint, truncator walimpls.WALImpls) *samplingTruncator {
...
func (t *samplingTruncator) applyTruncate() {
	...
	if truncateCheckpoint == nil {
		t.Logger().Info("no checkpoint sample can be used to truncate wal")
		return
	}
