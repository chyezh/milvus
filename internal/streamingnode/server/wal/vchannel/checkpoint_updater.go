...
// active vchannels of the pchannel.
func newPChannelCheckpointUpdater(pchannel string, vchannels func() []string, getCheckpoint func() *utility.WALCheckpoint, reporter checkpointReporter) *PChannelCheckpointUpdater {
