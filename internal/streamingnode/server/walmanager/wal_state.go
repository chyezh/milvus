...
func newAvailableExpectedState(ctx context.Context, channel *streamingpb.PChannelInfo) expectedWALState {
...
type expectedWALState interface {
	...
	GetPChannelInfo() *streamingpb.PChannelInfo
...
func (s availableExpectedWALState) GetPChannelInfo() *streamingpb.PChannelInfo {
	return s.channel
}
...
func (s unavailableExpectedWALState) GetPChannelInfo() *streamingpb.PChannelInfo {
	return nil
}
