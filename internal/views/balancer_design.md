...
> Reference: [Distributed Query View Design](distributed_query_view_design.md), [Shard View Management](shard_view_management.md), [Syncer Design](syncer.md), [QueryView State Machine](query_view_state_machine.md), [view.proto](../../pkg/proto/view.proto)
