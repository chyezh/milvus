...
// currentWALState is the current state of a wal.
...
// expectedWALState is the expected state of a wal.
type expectedWALState interface {
	...
	GetPChannelInfo() *logpb.PChannelInfo
...
func (s availableExpectedWALState) GetPChannelInfo() *logpb.PChannelInfo {
	return s.channel
}
...
func (s unavailableExpectedWALState) GetPChannelInfo() *logpb.PChannelInfo {
	return nil
}
