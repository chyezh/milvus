...
func (hs *handlerServiceImpl) Produce(streamServer logpb.LogNodeHandlerService_ProduceServer) error {
	metrics.LogNodeProducerTotal.WithLabelValues(paramtable.GetNodeIDString()).Inc()
	defer metrics.LogNodeProducerTotal.WithLabelValues(paramtable.GetNodeIDString()).Dec()
...
func (hs *handlerServiceImpl) Consume(streamServer logpb.LogNodeHandlerService_ConsumeServer) error {
	metrics.LogNodeConsumerTotal.WithLabelValues(paramtable.GetNodeIDString()).Inc()
	defer metrics.LogNodeConsumerTotal.WithLabelValues(paramtable.GetNodeIDString()).Dec()
