...
func (c *testWALReplicaManagerClient) ValidateRuntime(context.Context, int64, *streamingpb.StreamingNodeManagerValidateRuntimeRequest) (*streamingpb.StreamingNodeManagerValidateRuntimeResponse, error) {
	c.t.Helper()
	c.t.Fatalf("unexpected ValidateRuntime call")
	return nil, nil
}
