...
var (
	RegisterImportMessageV1CheckCallback = registerMessageCheckCallback[*message.ImportMessageHeader, *msgpb.ImportMsg]

	// RBAC
	RegisterPutUserV2CheckCallback  = registerMessageCheckCallback[*message.PutUserMessageHeader, *message.PutUserMessageBody]
	RegisterDropUserV2CheckCallback = registerMessageCheckCallback[*message.DropUserMessageHeader, *message.DropUserMessageBody]
	RegisterPutRoleV2CheckCallback  = registerMessageCheckCallback[*message.PutRoleMessageHeader, *message.PutRoleMessageBody]
	RegisterDropRoleV2CheckCallback = registerMessageCheckCallback[*message.DropRoleMessageHeader, *message.DropRoleMessageBody]

// RegisterPutUserRoleV2CheckCallback        = registerMessageCheckCallback[*message.PutUserRoleMessageHeader, *message.PutUserRoleMessageBody]
// RegisterDropUserRoleV2CheckCallback       = registerMessageCheckCallback[*message.DropUserRoleMessageHeader, *message.DropUserRoleMessageBody]
// RegisterGrantPrivilegeV2CheckCallback     = registerMessageCheckCallback[*message.GrantPrivilegeMessageHeader, *message.GrantPrivilegeMessageBody]
// RegisterRevokePrivilegeV2CheckCallback    = registerMessageCheckCallback[*message.RevokePrivilegeMessageHeader, *message.RevokePrivilegeMessageBody]
// RegisterPutPrivilegeGroupV2CheckCallback  = registerMessageCheckCallback[*message.PutPrivilegeGroupMessageHeader, *message.PutPrivilegeGroupMessageBody]
// RegisterDropPrivilegeGroupV2CheckCallback = registerMessageCheckCallback[*message.DropPrivilegeGroupMessageHeader, *message.DropPrivilegeGroupMessageBody]
)
