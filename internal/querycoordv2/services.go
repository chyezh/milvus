...
func (s *Server) LoadCollection(ctx context.Context, req *querypb.LoadCollectionRequest) (*commonpb.Status, error) {
	...
	broadcaster, err := broadcast.StartBroadcastWithResourceKeys(ctx, message.NewCollectionNameResourceKey(req.Schema.GetDbName(), req.Schema.GetDbName()))
	if err != nil {
		return nil, err
	}
	...
	msg, err := loadJob.GeneratePutLoadConfigMessage(ctx)
	if err != nil {
		return nil, err
	}
