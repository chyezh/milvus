...
func (_m *MockMixCoordClient) GetStreamingNodeQueryViewResources(ctx context.Context, in *querypb.GetStreamingNodeQueryViewResourcesRequest, opts ...grpc.CallOption) (*querypb.GetStreamingNodeQueryViewResourcesResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_c *MockMixCoordClient_GetStreamingNodeQueryViewResources_Call) Run(run func(ctx context.Context, in *querypb.GetStreamingNodeQueryViewResourcesRequest, opts ...grpc.CallOption)) *MockMixCoordClient_GetStreamingNodeQueryViewResources_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockMixCoordClient_GetStreamingNodeQueryViewResources_Call) Return(_a0 *querypb.GetStreamingNodeQueryViewResourcesResponse, _a1 error) *MockMixCoordClient_GetStreamingNodeQueryViewResources_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMixCoordClient_GetStreamingNodeQueryViewResources_Call) RunAndReturn(run func(context.Context, *querypb.GetStreamingNodeQueryViewResourcesRequest, ...grpc.CallOption) (*querypb.GetStreamingNodeQueryViewResourcesResponse, error)) *MockMixCoordClient_GetStreamingNodeQueryViewResources_Call {
	_c.Call.Return(run)
	return _c
}
