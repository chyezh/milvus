...
import (
	...
	grpcresolver "github.com/milvus-io/milvus/internal/util/grpcutil/resolver"
)
...
func (_m *MockBuilder) Resolver() grpcresolver.Resolver {
	ret := _m.Called()
	...
	var r0 grpcresolver.Resolver
	if rf, ok := ret.Get(0).(func() grpcresolver.Resolver); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(grpcresolver.Resolver)
		}
	}
...
func (_c *MockBuilder_Resolver_Call) Return(_a0 grpcresolver.Resolver) *MockBuilder_Resolver_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockBuilder_Resolver_Call) RunAndReturn(run func() grpcresolver.Resolver) *MockBuilder_Resolver_Call {
	_c.Call.Return(run)
	return _c
}
