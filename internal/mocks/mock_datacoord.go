...
// RegisterStreamingCoordGRPCService provides a mock function with given fields: _a0
func (_m *MockDataCoord) RegisterStreamingCoordGRPCService(_a0 *grpc.Server) {
	_m.Called(_a0)
}
...
//   - _a0 *grpc.Server
func (_e *MockDataCoord_Expecter) RegisterStreamingCoordGRPCService(_a0 interface{}) *MockDataCoord_RegisterStreamingCoordGRPCService_Call {
	return &MockDataCoord_RegisterStreamingCoordGRPCService_Call{Call: _e.mock.On("RegisterStreamingCoordGRPCService", _a0)}
}

func (_c *MockDataCoord_RegisterStreamingCoordGRPCService_Call) Run(run func(_a0 *grpc.Server)) *MockDataCoord_RegisterStreamingCoordGRPCService_Call {
	_c.Call.Run(func(args mock.Arguments) {
