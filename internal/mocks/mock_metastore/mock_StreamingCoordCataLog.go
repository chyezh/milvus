...
func (_m *MockStreamingCoordCataLog) ListPChannel(ctx context.Context) ([]*streamingpb.PChannelInfo, error) {
	ret := _m.Called(ctx)

	var r0 []*streamingpb.PChannelInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]*streamingpb.PChannelInfo, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []*streamingpb.PChannelInfo); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockStreamingCoordCataLog_ListPChannel_Call) Return(_a0 []*streamingpb.PChannelInfo, _a1 error) *MockStreamingCoordCataLog_ListPChannel_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStreamingCoordCataLog_ListPChannel_Call) RunAndReturn(run func(context.Context) ([]*streamingpb.PChannelInfo, error)) *MockStreamingCoordCataLog_ListPChannel_Call {
	_c.Call.Return(run)
	return _c
}

// SavePChannels provides a mock function with given fields: ctx, info
func (_m *MockStreamingCoordCataLog) SavePChannels(ctx context.Context, info []*streamingpb.PChannelInfo) error {
...
func (_c *MockStreamingCoordCataLog_SavePChannels_Call) Run(run func(ctx context.Context, info []*streamingpb.PChannelInfo)) *MockStreamingCoordCataLog_SavePChannels_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]*streamingpb.PChannelInfo))
	})
	return _c
}
...
func (_c *MockStreamingCoordCataLog_SavePChannels_Call) RunAndReturn(run func(context.Context, []*streamingpb.PChannelInfo) error) *MockStreamingCoordCataLog_SavePChannels_Call {
	_c.Call.Return(run)
	return _c
}
