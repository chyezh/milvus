...
func (_m *MockQueryCoord) GetStreamingNodeQueryViewResources(_a0 context.Context, _a1 *querypb.GetStreamingNodeQueryViewResourcesRequest) (*querypb.GetStreamingNodeQueryViewResourcesResponse, error) {
	ret := _m.Called(_a0, _a1)
...
// MockQueryCoord_GetStreamingNodeQueryViewResources_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetStreamingNodeQueryViewResources'
type MockQueryCoord_GetStreamingNodeQueryViewResources_Call struct {
	*mock.Call
}
...
func (_e *MockQueryCoord_Expecter) GetStreamingNodeQueryViewResources(_a0 interface{}, _a1 interface{}) *MockQueryCoord_GetStreamingNodeQueryViewResources_Call {
	return &MockQueryCoord_GetStreamingNodeQueryViewResources_Call{Call: _e.mock.On("GetStreamingNodeQueryViewResources", _a0, _a1)}
}

func (_c *MockQueryCoord_GetStreamingNodeQueryViewResources_Call) Run(run func(_a0 context.Context, _a1 *querypb.GetStreamingNodeQueryViewResourcesRequest)) *MockQueryCoord_GetStreamingNodeQueryViewResources_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockQueryCoord_GetStreamingNodeQueryViewResources_Call) Return(_a0 *querypb.GetStreamingNodeQueryViewResourcesResponse, _a1 error) *MockQueryCoord_GetStreamingNodeQueryViewResources_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryCoord_GetStreamingNodeQueryViewResources_Call) RunAndReturn(run func(context.Context, *querypb.GetStreamingNodeQueryViewResourcesRequest) (*querypb.GetStreamingNodeQueryViewResourcesResponse, error)) *MockQueryCoord_GetStreamingNodeQueryViewResources_Call {
	_c.Call.Return(run)
	return _c
}
