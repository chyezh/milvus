...
func (_m *MockShardManager) Logger() *log.Logger {
	ret := _m.Called()
...
func (_c *MockShardManager_Logger_Call) Return(_a0 *log.Logger) *MockShardManager_Logger_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockShardManager_Logger_Call) RunAndReturn(run func() *log.Logger) *MockShardManager_Logger_Call {
	_c.Call.Return(run)
	return _c
}
