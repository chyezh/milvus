...
func (_m *MockManager) GetAllAvailableChannels() ([]*streamingpb.PChannelInfo, error) {
	ret := _m.Called()

	var r0 []*streamingpb.PChannelInfo
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]*streamingpb.PChannelInfo, error)); ok {
		return rf()
	}
...
func (_c *MockManager_GetAllAvailableChannels_Call) Return(_a0 []*streamingpb.PChannelInfo, _a1 error) *MockManager_GetAllAvailableChannels_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockManager_GetAllAvailableChannels_Call) RunAndReturn(run func() ([]*streamingpb.PChannelInfo, error)) *MockManager_GetAllAvailableChannels_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockManager) Open(ctx context.Context, channel *streamingpb.PChannelInfo) error {
...
func (_c *MockManager_Open_Call) Run(run func(ctx context.Context, channel *streamingpb.PChannelInfo)) *MockManager_Open_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockManager_Open_Call) RunAndReturn(run func(context.Context, *streamingpb.PChannelInfo) error) *MockManager_Open_Call {
	_c.Call.Return(run)
	return _c
}
