...
import (
	...
	walmanager "github.com/milvus-io/milvus/internal/streamingnode/server/walmanager"
)
...
// Open provides a mock function with given fields: ctx, channel, opt
func (_m *MockManager) Open(ctx context.Context, channel types.PChannelInfo, opt *walmanager.OpenOption) error {
	ret := _m.Called(ctx, channel, opt)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, types.PChannelInfo, *walmanager.OpenOption) error); ok {
		r0 = rf(ctx, channel, opt)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockManager_Expecter) Open(ctx interface{}, channel interface{}, opt interface{}) *MockManager_Open_Call {
	return &MockManager_Open_Call{Call: _e.mock.On("Open", ctx, channel, opt)}
}

func (_c *MockManager_Open_Call) Run(run func(ctx context.Context, channel types.PChannelInfo, opt *walmanager.OpenOption)) *MockManager_Open_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.PChannelInfo), args[2].(*walmanager.OpenOption))
	})
	return _c
}
...
func (_c *MockManager_Open_Call) RunAndReturn(run func(context.Context, types.PChannelInfo, *walmanager.OpenOption) error) *MockManager_Open_Call {
	_c.Call.Return(run)
	return _c
}
