...
func (_m *MockQueryCoordClient) GetStreamingNodeQueryViewResources(ctx context.Context, in *querypb.GetStreamingNodeQueryViewResourcesRequest, opts ...grpc.CallOption) (*querypb.GetStreamingNodeQueryViewResourcesResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *querypb.GetStreamingNodeQueryViewResourcesRequest, ...grpc.CallOption) (*querypb.GetStreamingNodeQueryViewResourcesResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *querypb.GetStreamingNodeQueryViewResourcesRequest, ...grpc.CallOption) *querypb.GetStreamingNodeQueryViewResourcesResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *querypb.GetStreamingNodeQueryViewResourcesRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockQueryCoordClient_GetStreamingNodeQueryViewResources_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetStreamingNodeQueryViewResources'
type MockQueryCoordClient_GetStreamingNodeQueryViewResources_Call struct {
	*mock.Call
}

// GetStreamingNodeQueryViewResources is a helper method to define mock.On call
//   - ctx context.Context
//   - in *querypb.GetStreamingNodeQueryViewResourcesRequest
//   - opts ...grpc.CallOption
func (_e *MockQueryCoordClient_Expecter) GetStreamingNodeQueryViewResources(ctx interface{}, in interface{}, opts ...interface{}) *MockQueryCoordClient_GetStreamingNodeQueryViewResources_Call {
	return &MockQueryCoordClient_GetStreamingNodeQueryViewResources_Call{Call: _e.mock.On("GetStreamingNodeQueryViewResources",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockQueryCoordClient_GetStreamingNodeQueryViewResources_Call) Run(run func(ctx context.Context, in *querypb.GetStreamingNodeQueryViewResourcesRequest, opts ...grpc.CallOption)) *MockQueryCoordClient_GetStreamingNodeQueryViewResources_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*querypb.GetStreamingNodeQueryViewResourcesRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockQueryCoordClient_GetStreamingNodeQueryViewResources_Call) Return(_a0 *querypb.GetStreamingNodeQueryViewResourcesResponse, _a1 error) *MockQueryCoordClient_GetStreamingNodeQueryViewResources_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryCoordClient_GetStreamingNodeQueryViewResources_Call) RunAndReturn(run func(context.Context, *querypb.GetStreamingNodeQueryViewResourcesRequest, ...grpc.CallOption) (*querypb.GetStreamingNodeQueryViewResourcesResponse, error)) *MockQueryCoordClient_GetStreamingNodeQueryViewResources_Call {
	_c.Call.Return(run)
	return _c
}
