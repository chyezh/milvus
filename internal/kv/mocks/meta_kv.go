...
func (_m *MetaKv) LoadKVsWithPrefix(ctx context.Context, key string) ([]*mvccpb.KeyValue, error) {
	ret := _m.Called(ctx, key)
...
// MetaKv_LoadKVsWithPrefix_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LoadKVsWithPrefix'
type MetaKv_LoadKVsWithPrefix_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - key string
func (_e *MetaKv_Expecter) LoadKVsWithPrefix(ctx interface{}, key interface{}) *MetaKv_LoadKVsWithPrefix_Call {
	return &MetaKv_LoadKVsWithPrefix_Call{Call: _e.mock.On("LoadKVsWithPrefix", ctx, key)}
}

func (_c *MetaKv_LoadKVsWithPrefix_Call) Run(run func(ctx context.Context, key string)) *MetaKv_LoadKVsWithPrefix_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MetaKv_LoadKVsWithPrefix_Call) Return(_a0 []*mvccpb.KeyValue, _a1 error) *MetaKv_LoadKVsWithPrefix_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MetaKv_LoadKVsWithPrefix_Call) RunAndReturn(run func(context.Context, string) ([]*mvccpb.KeyValue, error)) *MetaKv_LoadKVsWithPrefix_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MetaKv) RemoveWithCmps(ctx context.Context, key string, cmps ...clientv3.Cmp) (bool, error) {
...
// MetaKv_RemoveWithCmps_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoveWithCmps'
type MetaKv_RemoveWithCmps_Call struct {
	*mock.Call
}
...
//   - key string
//   - cmps ...clientv3.Cmp
func (_e *MetaKv_Expecter) RemoveWithCmps(ctx interface{}, key interface{}, cmps ...interface{}) *MetaKv_RemoveWithCmps_Call {
	return &MetaKv_RemoveWithCmps_Call{Call: _e.mock.On("RemoveWithCmps",
		append([]interface{}{ctx, key}, cmps...)...)}
}

func (_c *MetaKv_RemoveWithCmps_Call) Run(run func(ctx context.Context, key string, cmps ...clientv3.Cmp)) *MetaKv_RemoveWithCmps_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MetaKv_RemoveWithCmps_Call) Return(_a0 bool, _a1 error) *MetaKv_RemoveWithCmps_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MetaKv_RemoveWithCmps_Call) RunAndReturn(run func(context.Context, string, ...clientv3.Cmp) (bool, error)) *MetaKv_RemoveWithCmps_Call {
	_c.Call.Return(run)
	return _c
}
