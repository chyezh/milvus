...
func formatFlags(args []string, flags *flag.FlagSet) (alias string, enableRootCoord, enableQueryCoord,
	enableIndexCoord, enableDataCoord, enableQueryNode, enableDataNode, enableIndexNode, enableProxy, enableStreamingNode bool,
) {
	...
	flags.BoolVar(&enableStreamingNode, typeutil.StreamingNodeRole, false, "enable log node")
